...
- The FOV preference is archived and remains editable on servers with cheats disabled. Startup and server joins do not automatically adjust it to the display aspect.
