...
- Demo playback has direct controls for pause/play (**Space**), five-second rewind/forward (**Left/Right**), and paused frame-step (**.**), with a compact on-screen legend that can be hidden with `cl_demoControlOverlay 0`.
