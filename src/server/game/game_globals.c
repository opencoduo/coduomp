...
uint8_t bulletPriorityMap[] = {1, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 0};
uint8_t riflePriorityMap[] = {1, 9, 9, 9, 8, 7, 6, 6, 6, 6, 5, 5, 4, 4, 4, 4, 3, 3, 0};

const char *modNames[] = {
    "MOD_UNKNOWN",           "MOD_PISTOL_BULLET", "MOD_RIFLE_BULLET",     "MOD_GRENADE", "MOD_GRENADE_SPLASH", "MOD_PROJECTILE",
    "MOD_PROJECTILE_SPLASH", "MOD_MELEE",         "MOD_HEAD_SHOT",        "MOD_MORTAR",  "MOD_MORTAR_SPLASH",  "MOD_DYNAMITE",
    "MOD_DYNAMITE_SPLASH",   "MOD_ARTILLERY",     "MOD_ARTILLERY_SPLASH", "MOD_WATER",   "MOD_CRUSH",          "MOD_CRUSH_TANK",
    "MOD_CRUSH_JEEP",        "MOD_TELEFRAG",      "MOD_FALLING",          "MOD_SUICIDE", "MOD_TRIGGER_HURT",   "MOD_EXPLOSIVE",
    "MOD_COLLISION",         "MOD_FLAME",         "MOD_MELEE_BINOCULARS"};
...
const char *hintStrings[] = {"",          "HINT_NONE", "HINT_ACTIVATE", "HINT_NOACTIVATE", "HINT_DOOR",     "HINT_DOOR_LOCKED",
                             "HINT_MG42", "HINT_LMG",  "HINT_HEALTH",   "HINT_LADDER",     "HINT_FRIENDLY", NULL};
