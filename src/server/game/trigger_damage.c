                             ...
                             int damage, int mod)
{
    ...
    /* A non-client activator falls back to the trigger's stored team field. */
    int activatorTeam = game_compat_trigger_damage_team(activator, trigger->droppedClipCount);
