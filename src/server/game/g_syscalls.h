...
/* Trace/Physics */
extern void trap_Trace(trace_t *trace, const float *start, const float *mins,
                       const float *maxs, const float *end, int passEntityNum,
                       int contentMask);
extern void trap_TraceCapsule(trace_t *trace, const float *start, const float *mins,
                              const float *maxs, const float *end, int passEntityNum,
                              int contentMask);
...
extern void trap_SightTraceCapsule(int32_t *traceResult, const float *start, const float *mins,
                                   ...
                                   int contentMask);
extern void trap_CM_BoxTrace(trace_t *trace, const float *start, const float *end,
                             const float *mins, const float *maxs, int model,
                             int brushMask);
extern void trap_CM_CapsuleTrace(trace_t *trace, const float *start, const float *end,
                                 const float *mins, const float *maxs, int model,
                                 int brushMask);
...
extern int trap_CM_CapsuleSightTrace(const float *start, const float *end,
                                     const float *mins, const float *maxs,
                                     int model, int brushMask);
extern void trap_LocationalTrace(trace_t *trace, const float *start, const float *end,
...
/* Cvar */
extern void trap_Cvar_Register(vmCvar_t *cvar, const char *name,
