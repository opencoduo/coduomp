...
typedef struct level_locals_s {
    ...
    int32_t gentity_size;                /* +0x008, size 4; checked metadata/decompiler for DAT_0024b528 access, none found; retained for num_entities +0x00c ABI. MANUALLY LABELLED */
    ...
    char abiGap_1fc_1ff[0x004];          /* +0x1fc, size 4; checked metadata/decompiler for DAT_0024b71c access, none found; retained for teamScoreAxis +0x200 ABI */
    int32_t teamScoreAxis;               /* +0x200, DAT_0024b720 */
    int32_t teamScoreAllies;             /* +0x204, DAT_0024b724 */
    char abiGap_208_20b[0x004];          /* +0x208, size 4; checked metadata/decompiler for DAT_0024b728 access, none found; retained for teamStatusTime +0x20c ABI */
    ...
    char abiGap_220c_220f[0x004];        /* +0x220c, size 4; checked metadata/decompiler for DAT_0024d72c access, none found; retained for playerCloneCursor +0x2210 ABI */
    ...
    float cachedBoundsWidth;             /* +0x2e70, AUDITED_DECOMPILER(0x69c21, 69c21_G_RunFrame.c, VERIFY-FIRST-FUNCTIONS-2026-06-17): cvar.value cache for g_bounds_width. */
    float cachedBoundsHeightStanding;    /* +0x2e74, AUDITED_DECOMPILER(0x69c21, 69c21_G_RunFrame.c, VERIFY-FIRST-FUNCTIONS-2026-06-17): cvar.value cache for g_bounds_height_standing. */
    float cachedViewheightStanding;      /* +0x2e78, AUDITED_DECOMPILER(0x69c21, 69c21_G_RunFrame.c, VERIFY-FIRST-FUNCTIONS-2026-06-17): cvar.value cache for bg_viewheight_standing. */
    float cachedViewheightCrouched;      /* +0x2e7c, AUDITED_DECOMPILER(0x69c21, 69c21_G_RunFrame.c, VERIFY-FIRST-FUNCTIONS-2026-06-17): cvar.value cache for bg_viewheight_crouched. */
    float cachedViewheightProne;         /* +0x2e80, AUDITED_DECOMPILER(0x69c21, 69c21_G_RunFrame.c, VERIFY-FIRST-FUNCTIONS-2026-06-17): cvar.value cache for bg_viewheight_prone. */
...
GAME_STATIC_ASSERT(level_notify_watch_entry_size,
                 sizeof(level_trigger_notify_watch_entry_t) == 0x0c);
...
GAME_STATIC_ASSERT(level_spawn_var_pairs_offset,
                 offsetof(level_locals_t, spawnVarPairSlots) ==
                 0x1774);
GAME_STATIC_ASSERT(level_spawn_var_pair_storage_size,
                 sizeof(((level_locals_t *)0)->spawnVarPairSlots) == 0x200);
GAME_STATIC_ASSERT(level_spawn_var_text_offset,
                 offsetof(level_locals_t, spawnText) ==
                 0x1978);
GAME_STATIC_ASSERT(level_spawn_var_text_size,
                 sizeof(((level_locals_t *)0)->spawnText) ==
                 2048);
