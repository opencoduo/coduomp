...
typedef void (*gentity_pain_t)(gentity_t *self, gentity_t *attacker,
                               int damage, const float *point,
                               int meansOfDeath, const float *direction,
                               int hitLocation);
typedef void (*gentity_die_t)(gentity_t *self, gentity_t *inflictor,
...
GAME_STATIC_ASSERT(gclient_player_state_health_offset,
                 offsetof(gclient_t, ps.stats[STAT_HEALTH]) == 0x11c);
GAME_STATIC_ASSERT(gclient_death_yaw_offset,
                 offsetof(gclient_t, ps.stats[STAT_DEAD_YAW]) == 0x120);
GAME_STATIC_ASSERT(gclient_max_health_offset,
                 offsetof(gclient_t, ps.stats[STAT_MAX_HEALTH]) == 0x124);
GAME_STATIC_ASSERT(gclient_ident_client_num_offset,
                 offsetof(gclient_t, ps.stats[STAT_IDENT_CLIENT_NUM]) == 0x128);
GAME_STATIC_ASSERT(gclient_ident_client_health_offset,
                 offsetof(gclient_t, ps.stats[STAT_IDENT_CLIENT_HEALTH]) == 0x12c);
GAME_STATIC_ASSERT(gclient_spawn_count_offset,
                 offsetof(gclient_t, ps.stats[STAT_SPAWN_COUNT]) == 0x130);
...
GAME_STATIC_ASSERT(vehicle_state_local_forward_accel_offset,
                 offsetof(vehicle_state_t, localAccel.components.forward) ==
                     0x2a4);
GAME_STATIC_ASSERT(vehicle_state_local_vertical_accel_offset,
                 offsetof(vehicle_state_t, localAccel.components.vertical) ==
                     0x2a8);
GAME_STATIC_ASSERT(vehicle_local_accel_size,
                 sizeof(vehicle_local_accel_t) == 0x08);
...
GAME_STATIC_ASSERT(bg_player_anim_pm_type_offset,
                 offsetof(clientInfo_t, moduleState.pmType) == 0x004);
...
GAME_STATIC_ASSERT(bg_player_anim_override_angle_offset,
                 offsetof(clientInfo_t, turretOverrideAngles[1]) == 0x3f8);
GAME_STATIC_ASSERT(bg_player_anim_override_pitch_offset,
                 offsetof(clientInfo_t, turretOverrideAngles[0]) == 0x3f4);
GAME_STATIC_ASSERT(bg_player_anim_override_yaw_offset,
                 offsetof(clientInfo_t, turretOverrideAngles[1]) == 0x3f8);
GAME_STATIC_ASSERT(bg_player_anim_override_roll_offset,
                 offsetof(clientInfo_t, turretOverrideAngles[2]) == 0x3fc);
GAME_STATIC_ASSERT(bg_player_anim_gun_hand_left_offset,
...
GAME_STATIC_ASSERT(entity_link_info_offset_column_offset,
                 offsetof(entityLinkInfo_t, relAxis.origin) == 0x34);
...
GAME_STATIC_ASSERT(hudelem_align_x_offset,
                 offsetof(game_hudElem_t, client.alignX) == 0x14);
GAME_STATIC_ASSERT(hudelem_align_y_offset,
                 offsetof(game_hudElem_t, client.alignY) == 0x18);
GAME_STATIC_ASSERT(hudelem_color_offset,
                 offsetof(game_hudElem_t, client.color) == 0x1c);
GAME_STATIC_ASSERT(hudelem_width_offset,
                 offsetof(game_hudElem_t, client.width) == 0x30);
GAME_STATIC_ASSERT(hudelem_height_offset,
                 offsetof(game_hudElem_t, client.height) == 0x34);
GAME_STATIC_ASSERT(hudelem_move_from_x_offset,
                 offsetof(game_hudElem_t, client.moveFromX) == 0x4c);
GAME_STATIC_ASSERT(hudelem_move_from_y_offset,
                 offsetof(game_hudElem_t, client.moveFromY) == 0x50);
GAME_STATIC_ASSERT(hudelem_move_start_time_offset,
                 offsetof(game_hudElem_t, client.moveStartTime) == 0x54);
GAME_STATIC_ASSERT(hudelem_move_time_offset,
                 offsetof(game_hudElem_t, client.moveTime) == 0x58);
GAME_STATIC_ASSERT(hudelem_text_offset,
                 offsetof(game_hudElem_t, client.text) == 0x68);
GAME_STATIC_ASSERT(hudelem_sort_offset,
                 offsetof(game_hudElem_t, client.sortKey) == 0x6c);
GAME_STATIC_ASSERT(hudelem_unused_78_offset,
                 offsetof(game_hudElem_t, client.unused78) == 0x78);
...
GAME_STATIC_ASSERT(gentity_entity_state_offset,
                 offsetof(gentity_t, s) == 0x000);
