...
enum {
    SCRIPT_VM_EXPORT_GET_FUNCTION = SCRIPT_IMPORT_CALLBACK_COUNT + SCRIPT_EXPORT_GET_FUNCTION,
    SCRIPT_VM_EXPORT_GET_METHOD = SCRIPT_IMPORT_CALLBACK_COUNT + SCRIPT_EXPORT_GET_METHOD,
    SCRIPT_VM_EXPORT_SET_OBJECT_FIELD = SCRIPT_IMPORT_CALLBACK_COUNT + SCRIPT_EXPORT_SET_OBJECT_FIELD,
    SCRIPT_VM_EXPORT_GET_OBJECT_FIELD = SCRIPT_IMPORT_CALLBACK_COUNT + SCRIPT_EXPORT_GET_OBJECT_FIELD,
    SCRIPT_VM_EXPORT_LOAD_READ = SCRIPT_IMPORT_CALLBACK_COUNT + SCRIPT_EXPORT_LOAD_READ,
    SCRIPT_VM_CALLBACK_COUNT = SCRIPT_IMPORT_CALLBACK_COUNT + SCRIPT_EXPORT_CALLBACK_COUNT
};

typedef char script_vm_callback_slot_size_must_match[sizeof(script_vm_callback_slot_t) == sizeof(script_callback_fn_t) ? 1 : -1];
...
#define DEFINE_VOID_4(name, slot, member, type1, arg1, type2, arg2, type3, arg3, type4, arg4) \
...
#define DEFINE_RET_0(ret, name, slot, member) \
    ret name(void) \
    { \
        return SCRIPT_VM_CALL((slot), member)(); \
    }

#define DEFINE_RET_1(ret, name, slot, member, type1, arg1) \
    ret name(type1 arg1) \
    { \
        return SCRIPT_VM_CALL((slot), member)(arg1); \
    }
...
#define DEFINE_RET_3(ret, name, slot, member, type1, arg1, type2, arg2, type3, arg3) \
    ret name(type1 arg1, type2 arg2, type3 arg3) \
    { \
        return SCRIPT_VM_CALL((slot), member)(arg1, arg2, arg3); \
    }

#define DEFINE_RET_4(ret, name, slot, member, type1, arg1, type2, arg2, type3, arg3, type4, arg4) \
...
DEFINE_RET_1(qboolean, Scr_GetBool, SCRIPT_IMPORT_GET_BOOL, bool_from_u32, uint32_t, index)
...
DEFINE_RET_1(int, Scr_GetInt, SCRIPT_IMPORT_GET_INT, int_from_u32, uint32_t, index)
...
DEFINE_RET_2(scr_anim_t, Scr_GetAnim, SCRIPT_IMPORT_GET_ANIM, anim_ref_from_u32_xanimtree, uint32_t, index, XAnimTree *, runtimeTree)
...
DEFINE_RET_1(script_anim_tree_ref_t, Scr_GetAnimTree, SCRIPT_IMPORT_GET_ANIM_TREE, anim_tree_ref_from_u32, uint32_t, index)
...
DEFINE_RET_1(float, Scr_GetFloat, SCRIPT_IMPORT_GET_FLOAT, float_from_u32, uint32_t, index)
...
DEFINE_RET_1(const char *, Scr_GetString, SCRIPT_IMPORT_GET_STRING, cstring_from_u32, uint32_t, index)
...
DEFINE_RET_1(uint16_t, Scr_GetConstString, SCRIPT_IMPORT_GET_CONST_STRING, u16_from_u32, uint32_t, index)
...
DEFINE_RET_1(const char *, Scr_GetDebugString, SCRIPT_IMPORT_GET_DEBUG_STRING, cstring_from_u32, uint32_t, index)
...
DEFINE_RET_1(const char *, Scr_GetIString, SCRIPT_IMPORT_GET_ISTRING, cstring_from_u32, uint32_t, index)
...
DEFINE_RET_1(uint16_t, Scr_GetConstIString, SCRIPT_IMPORT_GET_CONST_ISTRING, u16_from_u32, uint32_t, index)
...
DEFINE_VOID_2(Scr_GetVector, SCRIPT_IMPORT_GET_VECTOR, void_from_u32_floatp, uint32_t, index, float *, value)
...
DEFINE_RET_1(uint32_t, Scr_GetFunc, SCRIPT_IMPORT_GET_FUNC, u32_from_u32, uint32_t, index)
...
DEFINE_RET_1(script_variable_type_t, Scr_GetType, SCRIPT_IMPORT_GET_TYPE, variable_type_from_u32, uint32_t, index)
...
DEFINE_RET_1(script_variable_type_t, Scr_GetPointerType, SCRIPT_IMPORT_GET_POINTER_TYPE, variable_type_from_u32, uint32_t, index)
...
DEFINE_RET_2(uint32_t, Scr_GetEntityNum, SCRIPT_IMPORT_GET_ENTITY_NUM, u32_from_u32_intp, uint32_t, index, int *, classnum)
...
DEFINE_RET_0(uint32_t, Scr_GetNumParam, SCRIPT_IMPORT_GET_NUM_PARAM, u32_from_void)
...
DEFINE_VOID_1(Scr_AddBool, SCRIPT_IMPORT_ADD_BOOL, void_from_bool, qboolean, value)
...
DEFINE_VOID_1(Scr_AddFloat, SCRIPT_IMPORT_ADD_FLOAT, void_from_float, float, value)
...
DEFINE_VOID_1(Scr_AddAnim, SCRIPT_IMPORT_ADD_ANIM, void_from_u32, uint32_t, anim)
...
DEFINE_VOID_2(Scr_AddEntityNum, SCRIPT_IMPORT_ADD_ENTITY_NUM, void_from_int_int, int, entityNum, int, classnum)
...
DEFINE_VOID_1(Scr_AddString, SCRIPT_IMPORT_ADD_STRING, void_from_cstring, const char *, value)
...
DEFINE_VOID_1(Scr_AddIString, SCRIPT_IMPORT_ADD_ISTRING, void_from_cstring, const char *, value)
...
DEFINE_VOID_1(Scr_AddConstString, SCRIPT_IMPORT_ADD_CONST_STRING, void_from_u16, uint16_t, value)
...
DEFINE_VOID_1(Scr_AddVector, SCRIPT_IMPORT_ADD_VECTOR, void_from_const_floatp, const float *, value)
...
DEFINE_VOID_1(Scr_AddObject, SCRIPT_IMPORT_ADD_OBJECT, void_from_u16, uint16_t, objectId)
...
DEFINE_VOID_1(Scr_AddArrayStringIndexed, SCRIPT_IMPORT_ADD_ARRAY_STRING_INDEXED, void_from_u16, uint16_t, key)
...
DEFINE_VOID_0(Scr_BeginLoadScripts, SCRIPT_IMPORT_BEGIN_LOAD_SCRIPTS, void_from_void)
...
DEFINE_VOID_0(Scr_BeginLoadAnimTrees, SCRIPT_IMPORT_BEGIN_LOAD_ANIM_TREES, void_from_void)
...
DEFINE_VOID_0(Scr_EndLoadScripts, SCRIPT_IMPORT_END_LOAD_SCRIPTS, void_from_void)
...
DEFINE_VOID_0(Scr_EndLoadAnimTrees, SCRIPT_IMPORT_END_LOAD_ANIM_TREES, void_from_void)
...
DEFINE_VOID_1(Scr_PrecacheAnimTrees, SCRIPT_IMPORT_PRECACHE_ANIM_TREES, void_from_anim_tree_alloc, script_anim_tree_alloc_t, alloc)
...
DEFINE_VOID_1(Scr_FreeScripts, SCRIPT_IMPORT_FREE_SCRIPTS, void_from_u8, uint8_t, mode)
...
DEFINE_VOID_1(Scr_FreeGameVariable, SCRIPT_IMPORT_FREE_GAME_VARIABLE, void_from_bool, qboolean, freeAll)
...
DEFINE_VOID_1(Scr_ShutdownSystem, SCRIPT_IMPORT_SHUTDOWN_SYSTEM, void_from_u8, uint8_t, mode)
...
DEFINE_RET_1(qboolean, Scr_IsSystemActive, SCRIPT_IMPORT_IS_SYSTEM_ACTIVE, bool_from_u8, uint8_t, system)
...
DEFINE_VOID_2(Scr_AddExecThread, SCRIPT_IMPORT_ADD_EXEC_THREAD, void_from_u32_u32, uint32_t, handle, uint32_t, paramCount)
...
DEFINE_VOID_4(Scr_AddExecEntThreadNum, SCRIPT_IMPORT_ADD_EXEC_ENT_THREAD_NUM, void_from_int_int_u32_u32, int32_t, entityNum, int32_t,
              classnum, uint32_t, handle, uint32_t, paramCount)
...
DEFINE_RET_2(uint16_t, Scr_ExecThread, SCRIPT_IMPORT_EXEC_THREAD, u16_from_u32_u32, uint32_t, handle, uint32_t, paramCount)
...
DEFINE_RET_4(uint16_t, Scr_ExecEntThreadNum, SCRIPT_IMPORT_EXEC_ENT_THREAD_NUM, u16_from_int_int_u32_u32, int32_t, entityNum, int32_t,
             classnum, uint32_t, handle, uint32_t, paramCount)
...
DEFINE_RET_1(qboolean, Scr_IsThreadAlive, SCRIPT_IMPORT_IS_THREAD_ALIVE, bool_from_u16, uint16_t, threadId)
...
DEFINE_VOID_1(Scr_Error, SCRIPT_IMPORT_ERROR, void_from_cstring, const char *, message)
...
DEFINE_VOID_2(Scr_ErrorWithDialogMessage, SCRIPT_IMPORT_ERROR_WITH_DIALOG_MESSAGE, void_from_cstring_cstring, const char *, message,
...
DEFINE_VOID_2(Scr_ParamError, SCRIPT_IMPORT_PARAM_ERROR, void_from_int_cstring, int32_t, index, const char *, message)
...
DEFINE_VOID_1(Scr_ObjectError, SCRIPT_IMPORT_OBJECT_ERROR, void_from_cstring, const char *, message)
...
DEFINE_VOID_3(Scr_SetDynamicEntityField, SCRIPT_IMPORT_SET_DYNAMIC_ENTITY_FIELD, void_from_int_int_u16, int, entityNum, int, classnum,
              uint16_t, fieldName)
...
DEFINE_VOID_2(Scr_FreeEntityNum, SCRIPT_IMPORT_FREE_ENTITY_NUM, void_from_int_int, int, entityNum, int, classnum)
...
DEFINE_RET_2(uint16_t, Scr_GetEntityId, SCRIPT_IMPORT_GET_ENTITY_ID, u16_from_int_int, int, entityNum, int, classnum)
...
DEFINE_VOID_2(Scr_SetClassMap, SCRIPT_IMPORT_SET_CLASS_MAP, void_from_classmap_u32, script_class_map_entry_t *, classMap, uint32_t,
              classCount)
...
DEFINE_VOID_0(Scr_RemoveClassMap, SCRIPT_IMPORT_REMOVE_CLASS_MAP, void_from_void)
...
DEFINE_VOID_3(Scr_AddClassField, SCRIPT_IMPORT_ADD_CLASS_FIELD, void_from_u16_cstring_u16, uint16_t, classnum, const char *, name, uint16_t,
              fieldIndex)
...
DEFINE_VOID_2(Scr_AddFields, SCRIPT_IMPORT_ADD_FIELDS, void_from_cstring_cstring, const char *, path, const char *, extension)
...
DEFINE_RET_2(uint16_t, Scr_FindField, SCRIPT_IMPORT_FIND_FIELD, u16_from_cstring_intp, const char *, name, int *, type)
...
DEFINE_RET_2(uint32_t, Scr_GetOffset, SCRIPT_IMPORT_GET_OFFSET, u32_from_u16_cstring, uint16_t, classnum, const char *, name)
...
DEFINE_VOID_3(Scr_CopyEntityNum, SCRIPT_IMPORT_COPY_ENTITY_NUM, void_from_int_int_int, int, sourceEntityNum, int, destEntityNum, int,
              classnum)
...
DEFINE_VOID_3(Scr_Init, SCRIPT_IMPORT_INIT, void_from_int_int_int, int32_t, debugReport, int32_t, developerScript, int32_t, developer)
...
DEFINE_VOID_1(Scr_SetLoading, SCRIPT_IMPORT_SET_LOADING, void_from_int, int, loading)
...
DEFINE_VOID_2(Scr_InitSystem, SCRIPT_IMPORT_INIT_SYSTEM, void_from_u32_u32, uint32_t, system, uint32_t, time)
...
DEFINE_VOID_0(Scr_AllocGameVariable, SCRIPT_IMPORT_ALLOC_GAME_VARIABLE, void_from_void)
...
DEFINE_RET_0(qboolean, Scr_HasSourceFiles, SCRIPT_IMPORT_HAS_SOURCE_FILES, bool_from_void)
...
DEFINE_VOID_1(Scr_SaveSource, SCRIPT_IMPORT_SAVE_SOURCE, void_from_source_io, script_source_io_fn_t, writeData)
...
DEFINE_VOID_1(Scr_LoadSource, SCRIPT_IMPORT_LOAD_SOURCE, void_from_source_io, script_source_io_fn_t, readData)
...
DEFINE_VOID_1(Scr_SkipSource, SCRIPT_IMPORT_SKIP_SOURCE, void_from_source_io, script_source_io_fn_t, readData)
...
DEFINE_VOID_1(Scr_SavePre, SCRIPT_IMPORT_SAVE_PRE, void_from_voidp, void *, file)
...
DEFINE_VOID_1(Scr_SavePost, SCRIPT_IMPORT_SAVE_POST, void_from_voidp, void *, file)
...
DEFINE_VOID_2(Scr_LoadPre, SCRIPT_IMPORT_LOAD_PRE, void_from_voidp_int, void *, file, int, scriptRunning)
...
DEFINE_RET_1(qboolean, Scr_LoadScript, SCRIPT_IMPORT_LOAD_SCRIPT, bool_from_cstring, const char *, scriptName)
...
DEFINE_RET_1(XAnim *, Scr_FindAnimTree, SCRIPT_IMPORT_FIND_ANIM_TREE, xanim_from_cstring, const char *, treeName)
#else
...
DEFINE_RET_1(script_anim_tree_ref_t, Scr_FindAnimTree, SCRIPT_IMPORT_FIND_ANIM_TREE, anim_tree_ref_from_cstring, const char *, treeName)
#endif
...
DEFINE_VOID_3(Scr_FindAnim, SCRIPT_IMPORT_FIND_ANIM, void_from_cstring_cstring_animref, const char *, treeName, const char *, animName,
              scr_anim_t *, outAnim)
...
DEFINE_RET_2(uint32_t, Scr_GetFunctionHandle, SCRIPT_IMPORT_GET_FUNCTION_HANDLE, u32_from_cstring_cstring, const char *, scriptName,
...
DEFINE_VOID_1(Scr_FreeThread, SCRIPT_IMPORT_FREE_THREAD, void_from_u16, uint16_t, threadId)
...
DEFINE_RET_1(uint16_t, Scr_ConvertThreadToSave, SCRIPT_IMPORT_CONVERT_THREAD_TO_SAVE, u16_from_u16, uint16_t, threadId)
...
DEFINE_RET_1(uint16_t, Scr_ConvertThreadFromLoad, SCRIPT_IMPORT_CONVERT_THREAD_FROM_LOAD, u16_from_u16, uint16_t, threadId)
...
DEFINE_VOID_2(Scr_SetString, SCRIPT_IMPORT_SET_STRING, void_from_voidp_u16, uint16_t *, slot, uint16_t, value)
...
DEFINE_RET_2(uint16_t, Scr_AllocString, SCRIPT_IMPORT_ALLOC_STRING, u16_from_cstring_int, const char *, value, int, user)
...
DEFINE_VOID_4(Scr_NotifyNum, SCRIPT_IMPORT_NOTIFY_NUM, void_from_int_int_u16_u32, int32_t, entityNum, int32_t, classnum, uint16_t, event,
              uint32_t, paramCount)
...
DEFINE_VOID_3(Scr_NotifyId, SCRIPT_IMPORT_NOTIFY_ID, void_from_u16_u16_u32, uint16_t, objectId, uint16_t, event, uint32_t, paramCount)
...
DEFINE_RET_1(const char *, SL_ConvertToString, SCRIPT_IMPORT_SL_CONVERT_TO_STRING, cstring_from_u16, uint16_t, stringId)
...
DEFINE_RET_2(uint16_t, SL_GetString, SCRIPT_IMPORT_SL_GET_STRING, u16_from_cstring_u8, const char *, value, uint8_t, user)
...
DEFINE_RET_2(uint16_t, SL_GetLowercaseString, SCRIPT_IMPORT_SL_GET_LOWERCASE_STRING, u16_from_cstring_u8, const char *, value, uint8_t,
             user)
...
DEFINE_RET_1(uint16_t, SL_FindLowercaseString, SCRIPT_IMPORT_SL_FIND_LOWERCASE_STRING, u16_from_cstring, const char *, value)
...
DEFINE_RET_1(uint16_t, Scr_CreateCanonicalFilename, SCRIPT_IMPORT_CREATE_CANONICAL_FILENAME, u16_from_cstring, const char *, filename)
...
DEFINE_VOID_1(Scr_SetTime, SCRIPT_IMPORT_SET_TIME, void_from_u32, uint32_t, time)
...
DEFINE_VOID_0(Scr_RunCurrentThreads, SCRIPT_IMPORT_RUN_CURRENT_THREADS, void_from_void)
...
DEFINE_RET_1(uint32_t, Scr_GetAnimsIndex, SCRIPT_IMPORT_GET_ANIMS_INDEX, u32_from_xanim, XAnim *, anims)
...
DEFINE_RET_1(XAnim *, Scr_GetAnims, SCRIPT_IMPORT_GET_ANIMS, xanim_from_u32, uint32_t, animsIndex)
...
DEFINE_RET_2(void *, MT_Alloc, SCRIPT_IMPORT_MT_ALLOC, voidp_from_size_int, size_t, size, int, tag)
...
DEFINE_VOID_2(MT_Free, SCRIPT_IMPORT_MT_FREE, void_from_voidp_size, void *, ptr, size_t, size)
...
script_callback_fn_t *Scr_FarHook(script_callback_fn_t *engineCallbacks)
{
    if (engineCallbacks != NULL) {
        for (size_t index = 0; index < SCRIPT_IMPORT_CALLBACK_COUNT; index++) {
            scriptVmCallbacks[index].generic = engineCallbacks[index];
        }
    }

    scriptVmCallbacks[SCRIPT_VM_EXPORT_GET_FUNCTION].function_lookup = Scr_GetFunction;
    scriptVmCallbacks[SCRIPT_VM_EXPORT_GET_METHOD].method_lookup = Scr_GetMethod;
    scriptVmCallbacks[SCRIPT_VM_EXPORT_SET_OBJECT_FIELD].object_field = Scr_SetObjectField;
    scriptVmCallbacks[SCRIPT_VM_EXPORT_GET_OBJECT_FIELD].object_field = Scr_GetObjectField;
