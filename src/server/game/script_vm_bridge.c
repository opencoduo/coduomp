...
/* NOT_FROM_ORIGINAL_SOURCE: preserve the float argument's exact bits.
 * GCC i386 can otherwise forward it through x87 FLD/FSTP, which can
 * quiet signaling NaNs and change floating-point exception status. */
