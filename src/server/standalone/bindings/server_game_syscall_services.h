...
int32_t FS_FOpenFileByMode(const char *path, int32_t *handleOut, fsMode_t mode);
...
void CM_BoxTrace(trace_t *trace, const vec3_t start, const vec3_t end, const vec3_t mins, const vec3_t maxs, int32_t model,
                 int32_t brushMask, qboolean capsule);
int32_t CM_BoxSightTrace(int32_t result, const vec3_t start, const vec3_t end, const vec3_t mins, const vec3_t maxs, int32_t model,
                         int32_t brushMask, qboolean capsule);
int32_t CM_AreaEntities(const vec3_t mins, const vec3_t maxs, int32_t *entityList, int32_t maxCount, int32_t contentMask);
char *Com_Parse(char **data);
void Q_strncpyz(char *destination, const char *source, int32_t destinationSize);
...
static inline void server_compat_game_debug_string(const intptr_t *arguments)
{
    (void)arguments;
}
...
static inline void server_compat_game_debug_line(const intptr_t *arguments)
{
    (void)arguments;
}
...
static inline void *server_compat_get_weapon_info_memory(int32_t byteCount, int32_t *previousOwner, int32_t callerOwner)
{
 ...
 * ownership protocol. */
static inline void server_compat_free_weapon_info_memory(int32_t callerOwner, qboolean preserveAllocation)
{
