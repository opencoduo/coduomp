...
#define COM_EVENT_DISPATCH_KEY(event_) CL_KeyEvent((event_).value, (event_).value2, (event_).time)
...
#define COM_EVENT_DISPATCH_MOUSE(event_) CL_MouseEvent((event_).value, (event_).value2, (event_).time)
#define COM_EVENT_DISPATCH_JOYSTICK(event_) CL_JoystickEvent((event_).value, (event_).value2, (event_).time)
