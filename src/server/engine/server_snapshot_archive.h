...
void SV_AddArchivedEntToSnapshot(
    int32_t entityNum, snapshotEntityNumbers_t *entityNumbers);
...
qboolean SV_GetCurrentClientInfo(int32_t clientNum,
                                 playerState_t *playerStateOut,
                                 clientState_t *clientInfoOut);
qboolean SV_GetArchivedClientInfo(int32_t clientNum, int32_t *archiveTime,
                                  playerState_t *playerStateOut,
                                  clientState_t *clientInfoOut);
