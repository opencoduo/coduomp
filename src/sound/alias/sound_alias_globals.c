...
snd_alias_t *com_soundAliasHash[SND_ALIAS_BANK_COUNT][SND_ALIAS_HASH_BUCKET_COUNT];
                                                       /* 0x009678a8 */
...
char com_soundAliasSubtitleReference[SND_ALIAS_SUBTITLE_REFERENCE_CAPACITY];            /* 0x00968510 */
