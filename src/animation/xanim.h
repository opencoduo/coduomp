...
void XAnimAddClientNotify(XAnimInfo *node, XAnimEntry *entry,
                          uint16_t nameHandle, float timeFrac,
                          uint16_t notifyType);
void XAnimSetClientTime(XAnimInfo *node, XAnimEntry *entry,
                        uint16_t notifyType);
...
void XAnimClearGoalWeight(XAnimTree *tree, uint32_t animIndex,
                          float blendTime);
void XAnimClearTreeGoalWeights_r(XAnimTree *tree, uint32_t animIndex,
                                 float blendTime);
void XAnimClearTreeGoalWeights(XAnimTree *tree, uint32_t animIndex,
                               float blendTime);
void XAnimClearTreeGoalWeightsStrict(XAnimTree *tree, uint32_t animIndex,
                                     float blendTime);
...
int32_t XAnimSetGoalWeight(XAnimTree *tree, uint32_t animIndex,
                           ...
                           qboolean restart);
void XAnimSetCompleteGoalWeight(XAnimTree *tree, uint32_t animIndex,
                                float weight, float blendTime, float rate,
                                uint16_t notifyName, uint16_t notifyType,
                                qboolean restart);
void XAnimClearChildGoalWeights(XAnimTree *tree, uint32_t animIndex,
                                float blendTime);
int32_t XAnimSetGoalWeightKnob(XAnimTree *tree, uint32_t animIndex,
                               float weight, float blendTime, float rate,
                               uint16_t notifyName, uint16_t notifyType,
                               qboolean restart);
void XAnimSetCompleteGoalWeightKnob(
    XAnimTree *tree, uint32_t animIndex, float weight, float blendTime,
    float rate, uint16_t notifyName, uint16_t notifyType,
    qboolean restart);
