...
void XModelReadSurface(XSurface *surface, const uint8_t **position, xmodel_asset_alloc_fn alloc);
...
XModelSurfs *XModelSurfsCloneSurfs(const XModelSurfs *modelSurfs, xmodel_asset_alloc_fn alloc);
XModelSurfs *XModelSurfsPrecache(const char *name, xmodel_asset_alloc_fn alloc);
fileData_t *XModelPartsPrecache(const char *name, xmodel_asset_alloc_fn alloc);
...
const uint8_t *XModelLoadCollData(const uint8_t *cursor, XModelInfo *collision, xmodel_asset_alloc_fn alloc);
XModel *XModelPrecache(const char *name, xmodel_load_mode_t loadMode, xmodel_asset_alloc_fn alloc, xmodel_asset_alloc_fn optionalAlloc);
...
void XSurfaceRemapTextureCoordinates(XSurface *surface, const vec2_t scale, const vec2_t offset, int32_t sourceUIndex,
