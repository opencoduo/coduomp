...
extern uint16_t
    script_animTreeHandles[SCRIPT_ANIM_SLOT_COUNT]
                          [SCRIPT_ANIM_TREE_SLOT_COUNT];
extern uint16_t script_animTreeRoot;
extern XAnim
    *script_animTrees[SCRIPT_ANIM_SLOT_COUNT][SCRIPT_ANIM_TREE_SLOT_COUNT];
...
void ConnectScriptToAnim(uint16_t unresolvedRoot, int32_t nodeIndex,
                         uint16_t treeName, uint16_t animName,
                         int32_t treeIndex);
