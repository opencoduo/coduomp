...
#define CODUO_X87_TRUNCATE_I32_FIRST(controlPointer, expression) \
    __extension__({ \
        coduo_x87_truncation_control_t *coduo_x87_control_ = (controlPointer); \
        register long double coduo_x87_value_ = (expression); \
        int32_t coduo_x87_result_; \
        __asm__ __volatile__("fnstcw %[saved]\n\t" \
                             "movzwl %[saved], %%eax\n\t" \
                             ...
                             : [saved] "=m"(coduo_x87_control_->savedControlWord), \
                               [truncate] "=m"(coduo_x87_control_->truncateControlWord), [result] "=m"(coduo_x87_result_) \
                             : "t"(coduo_x87_value_), [truncateBits] "i"(CODUO_X87_TRUNCATE_ROUNDING_BITS) \
                             : "eax", "cc", "memory", "st"); \
        coduo_x87_result_; \
    })
...
#define CODUO_X87_TRUNCATE_I32_NEXT(controlPointer, expression) \
    __extension__({ \
        const coduo_x87_truncation_control_t *coduo_x87_control_ = (controlPointer); \
        register long double coduo_x87_value_ = (expression); \
        int32_t coduo_x87_result_; \
        __asm__ __volatile__("fldcw %[truncate]\n\t" \
                             "fistpl %[result]\n\t" \
                             "fldcw %[saved]" \
                             : [result] "=m"(coduo_x87_result_) \
                             : "t"(coduo_x87_value_), [saved] "m"(coduo_x87_control_->savedControlWord), \
...
#define CODUO_X87_TRUNCATE_I32(expression) \
    __extension__({ \
        ...
        CODUO_X87_TRUNCATE_I32_FIRST(&coduo_x87_direct_control_, (expression)); \
    })
...
#define CODUO_X87_SCALE_F32_TRUNCATE_I32(expression, scaleExpression) \
    __extension__({ \
        ...
        __asm__ __volatile__( \
            CODUO_X87_SCALE_F32_INSTRUCTIONS "fnstcw %[saved]\n\t" \
                                             "movzwl %[saved], %%eax\n\t" \
                                             "orw $%c[truncateBits], %%ax\n\t" \
                                             "movw %%ax, %[truncate]\n\t" \
                                             "fldcw %[truncate]\n\t" \
                                             "fistpl %[result]\n\t" \
                                             "fldcw %[saved]" \
            : [saved] "=m"(coduo_x87_scale_control_.savedControlWord), [truncate] "=m"(coduo_x87_scale_control_.truncateControlWord), \
              [result] "=m"(coduo_x87_scale_result_) \
            : "t"(coduo_x87_scale_value_), [scale] "m"(scaleExpression), [truncateBits] "i"(CODUO_X87_TRUNCATE_ROUNDING_BITS) \
...
#define CODUO_X87_TRUNCATE_I16(expression) \
    __extension__({ \
        coduo_x87_truncation_control_t coduo_x87_direct_control_; \
        CODUO_X87_TRUNCATE_I16_FIRST(&coduo_x87_direct_control_, (expression)); \
    })
...
#define CODUO_X87_TRUNCATE_I64(expression) \
    __extension__({ \
        ...
        __asm__ __volatile__( \
            ...
            "fistpq %[result]\n\t" \
            "fldcw %[saved]" \
            : [saved] "=m"(coduo_x87_saved_control_), [truncate] "=m"(coduo_x87_truncate_control_), [result] "=m"(coduo_x87_result_) \
            : "t"(coduo_x87_value_), [truncateBits] "i"(CODUO_X87_TRUNCATE_ROUNDING_BITS) \
            : "eax", "cc", "memory", "st"); \
        coduo_x87_result_; \
    })
...
static CODUO_X87_ALWAYS_INLINE void coduo_x87_sincosf(float angle, float *sinOut, float *cosOut)
{
#if (defined(__i386__) || defined(__x86_64__)) && (defined(__GNUC__) || defined(__clang__))
...
static CODUO_X87_ALWAYS_INLINE void coduo_x87_sincos(double angle, double *sinOut, double *cosOut)
{
#if (defined(__i386__) || defined(__x86_64__)) && (defined(__GNUC__) || defined(__clang__))
...
static CODUO_X87_ALWAYS_INLINE long double coduo_x87_sinl(long double angle)
{
#if (defined(__i386__) || defined(__x86_64__)) && (defined(__GNUC__) || defined(__clang__))
...
static CODUO_X87_ALWAYS_INLINE long double coduo_x87_tanl(long double angle)
{
#if (defined(__i386__) || defined(__x86_64__)) && (defined(__GNUC__) || defined(__clang__))
...
static CODUO_X87_ALWAYS_INLINE long double coduo_x87_atan2l(long double y, long double x)
{
#if (defined(__i386__) || defined(__x86_64__)) && (defined(__GNUC__) || defined(__clang__))
    long double result;

    __asm__ __volatile__("fpatan" : "=t"(result) : "0"(x), "u"(y) : "st(1)");
    return result;
#elif defined(__GNUC__) || defined(__clang__)
...
static CODUO_X87_ALWAYS_INLINE long double coduo_x87_sqrtl(long double value)
{
#if (defined(__i386__) || defined(__x86_64__)) && (defined(__GNUC__) || defined(__clang__))
...
static CODUO_X87_ALWAYS_INLINE float coduo_x87_fcos_to_f32(long double angle)
{
#if (defined(__i386__) || defined(__x86_64__)) && (defined(__GNUC__) || defined(__clang__))
    float result;
...
static CODUO_X87_ALWAYS_INLINE int32_t coduo_x87_fistp_i32(long double value)
{
#if (defined(__i386__) || defined(__x86_64__)) && (defined(__GNUC__) || defined(__clang__))
    int32_t result;
    ...
    if (!isfinite(rounded) || rounded > (long double)INT32_MAX || rounded < (long double)INT32_MIN) {
        return INT32_MIN;
    }
...
static CODUO_X87_ALWAYS_INLINE int32_t coduo_x87_fistp_f32_i32(float value)
{
#if (defined(__i386__) || defined(__x86_64__)) && (defined(__GNUC__) || defined(__clang__))
    int32_t result;
