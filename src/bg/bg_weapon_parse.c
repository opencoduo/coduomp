 ...
 */
#define BG_WEAPON_FIELD(index_, key_, member_, i386_offset_, type_) {(key_), (int32_t)offsetof(weaponInfo_t, member_), (type_)}
...
#define BG_WEAPON_FIELD(index_, key_, member_, i386_offset_, type_) \
    bg_weapon_field_offset_check_##index_ = 1 / ((offsetof(weaponInfo_t, member_) == (i386_offset_)) ? 1 : 0)
#include "bg_weapon_field_defs.inc"
#undef BG_WEAPON_FIELD
};
#endif
...
static int32_t bg_compat_find_weapon_enum_value(const char *value, const char *const *names, int32_t count)
{
    int32_t index;
...
qboolean BG_ParseWeaponInfoSpecificFieldType(void *weaponInfoBase, const char *value, int32_t fieldType)
{
    ...
    case WEAPON_FIELD_PARSE_WEAPON_TYPE:
        parsed = bg_compat_find_weapon_enum_value(value, bg_weaponTypeNames, WEAPTYPE_COUNT);
    ...
    case WEAPON_FIELD_PARSE_WEAPON_CLASS:
        parsed = bg_compat_find_weapon_enum_value(value, bg_weaponClassNames, WEAPCLASS_COUNT);
    ...
    case WEAPON_FIELD_PARSE_AMMO_TYPE:
        parsed = bg_compat_find_weapon_enum_value(value, bg_weaponAmmoTypeNames, WEAPON_AMMO_TYPE_COUNT);
    ...
    case WEAPON_FIELD_PARSE_OVERLAY_RETICLE:
        parsed = bg_compat_find_weapon_enum_value(value, bg_weaponOverlayReticleNames, WEAPON_OVERLAY_RETICLE_COUNT);
    ...
    case WEAPON_FIELD_PARSE_WEAPON_SLOT:
        parsed = bg_compat_find_weapon_enum_value(value, bg_weaponSlotNames, WEAPSLOT_COUNT);
    ...
    case WEAPON_FIELD_PARSE_WEAPON_STANCE:
        parsed = bg_compat_find_weapon_enum_value(value, bg_weaponStanceNames, WEAPON_STANCE_COUNT);
    ...
    case WEAPON_FIELD_PARSE_PROJECTILE_EXPLOSION:
        parsed = bg_compat_find_weapon_enum_value(value, bg_weaponGrenadeTypeNames, WEAPON_GRENADE_TYPE_COUNT);
