 ...
 */
const char *const bg_weaponTypeNames[WEAPTYPE_COUNT] = {
    "bullet", "grenade", "projectile", "spotter", "gas"
};

const char *const bg_weaponOverlayReticleNames[
    WEAPON_OVERLAY_RETICLE_COUNT] = {
    "none", "crosshair", "FG42", "Springfield", "Gewehr43"
};

const char *const bg_weaponSlotNames[WEAPSLOT_COUNT] = {
    "none", "primary", "primaryb", "pistol", "grenade", "smokegrenade",
    "satchel", "binocular"
};

const char *const bg_weaponStanceNames[WEAPON_STANCE_COUNT] = {
    "stand", "duck", "prone"
};

const char *const bg_weaponClassNames[WEAPCLASS_COUNT] = {
    "rifle", "mg", "smg", "lmg", "pistol", "grenade", "rocketlauncher",
    "turret", "spotter", "non-player", "flamethrower"
};

const char *const bg_weaponAmmoTypeNames[WEAPON_AMMO_TYPE_COUNT] = {
    "smg", "pistol", "rifle", "lmg", "hmg", "umg"
};

const char *const bg_weaponGrenadeTypeNames[WEAPON_GRENADE_TYPE_COUNT] = {
    "grenade", "smoke", "rocket", "molotov", "artillery", "mortar", "tank",
    "b17", "none"
};
