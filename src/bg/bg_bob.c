...
#if EMULATE_X87
    const x87f result =
        x87f_add(x87f_mul(x87f_load_i32((uint8_t)ps->bobCycle), x87f_load_f32(0.0246399436f)), x87f_load_f32(6.2831854820f));
    return (long double)x87f_store_f64(result);
#else
    return (long double)(uint8_t)ps->bobCycle * 0.0246399436f + 6.2831854820f;
#endif
}
...
long double BG_GetVerticalBobFactor(const playerState_t *ps, float phase, float amplitude, float maxAmplitude)
{
...
#if EMULATE_X87
    x87f amplitudeWide = x87f_mul(x87f_load_f32(stanceScale), x87f_load_f32(amplitude));
    ...
    const x87f harmonicArgument = x87f_add(x87f_mul(x87f_load_f32(phase), x87f_load_f32(4.0f)), x87f_load_f32(1.5707964f));
    const long double harmonicSine = coduo_x87_sinl((long double)x87f_store_f64(harmonicArgument));
    x87f harmonic = x87f_mul(x87f_load_f64((double)harmonicSine), x87f_load_f32(0.2f));

    const x87f fundamentalArgument = x87f_add(x87f_load_f32(phase), x87f_load_f32(phase));
    const long double fundamentalSine = coduo_x87_sinl((long double)x87f_store_f64(fundamentalArgument));
    x87f result = x87f_add(harmonic, x87f_load_f64((double)fundamentalSine));
    result = x87f_mul(result, x87f_load_f32(clampedAmplitude));
    result = x87f_mul(result, x87f_load_f32(0.75f));
    return (long double)x87f_store_f64(result);
#else
    const long double amplitudeWide = (long double)stanceScale * (long double)amplitude;
    clampedAmplitude = (float)amplitudeWide;
    if (amplitudeWide > (long double)maxAmplitude) {
        clampedAmplitude = maxAmplitude;
    }

    const long double harmonic = coduo_x87_sinl((long double)phase * 4.0f + 1.5707964f) * 0.2f;
    const long double fundamental = coduo_x87_sinl((long double)phase + (long double)phase);
...
long double BG_GetHorizontalBobFactor(const playerState_t *ps, float phase, float amplitude, float maxAmplitude)
{
...
#if EMULATE_X87
    x87f clampedAmplitude = x87f_mul(x87f_load_f32(stanceScale), x87f_load_f32(amplitude));
    ...
    const x87f result = x87f_mul(x87f_load_f64((double)sine), clampedAmplitude);
    return (long double)x87f_store_f64(result);
#else
    long double clampedAmplitude = (long double)stanceScale * (long double)amplitude;
...
{
#if EMULATE_X87
    x87f phase = x87f_mul(x87f_div(x87f_load_i32((uint8_t)ps->bobCycle), x87f_load_f32(255.0f)), x87f_load_f64(3.141592653589793));
    return x87f_store_f32(x87f_add(x87f_add(phase, phase), x87f_load_f64(6.283185307179586)));
#else
    const long double phase = (long double)(uint8_t)ps->bobCycle / 255.0f * 3.141592653589793L;
...
#if EMULATE_X87
    const double fundamentalArgument = x87f_store_f64(x87f_add(x87f_load_f32(phase), x87f_load_f32(phase)));
    fundamental = (float)CoduoLibm_Sin(fundamentalArgument);
    const double harmonicArgument =
        x87f_store_f64(x87f_add(x87f_mul(x87f_load_f32(phase), x87f_load_f32(4.0f)), x87f_load_f64(1.5707963267948966)));
    harmonic = (float)CoduoLibm_Sin(harmonicArgument);
    fundamental = x87f_store_f32(x87f_add(x87f_load_f32(fundamental), x87f_mul(x87f_load_f32(harmonic), x87f_load_f32(0.2f))));
    fundamental = x87f_store_f32(x87f_mul(x87f_load_f32(0.75f), x87f_load_f32(fundamental)));
    return x87f_store_f32(x87f_mul(x87f_load_f32(fundamental), x87f_load_f32(clampedAmplitude)));
#else
    fundamental = (float)CoduoLibm_Sin((double)(phase + phase));
    harmonic = (float)CoduoLibm_Sin((double)((long double)phase * 4.0f + 1.5707963267948966L));
...
#if EMULATE_X87
    return x87f_store_f32(x87f_mul(x87f_load_f64(CoduoLibm_Sin((double)phase)), x87f_load_f32(clampedAmplitude)));
#else
