...
void VectorRotateAngles(const vec3_t input, const vec3_t angles, vec3_t output);
void VectorRotateAnglesAroundPoint(const vec3_t point, const vec3_t angles, const vec3_t origin, vec3_t output);
enum {
    BOX_ON_PLANE_SIDE_FRONT = 1,
    BOX_ON_PLANE_SIDE_BACK = 2,
    BOX_ON_PLANE_SIDE_CROSS = BOX_ON_PLANE_SIDE_FRONT | BOX_ON_PLANE_SIDE_BACK
};
...
void LocalMatrixTransformVector43(const vec3_t input, const float matrix[16], vec3_t output);
void DObjSkelMatrixTransformVector43(const vec3_t input, const float matrix[16], vec3_t output);
...
void DObjMatrixTransformVector43(const vec3_t point, const DObjSkelMat *matrix, vec3_t output);
void DObjMatrixInverseTransformVector43(const vec3_t point, const DObjSkelMat *matrix, vec3_t output);
void XSurfaceTransformPoint43(const vec3_t point, const DObjSkelMat *matrix, vec3_t output);
void XSurfaceAccumulateWeightedPoint43(const vec3_t point, float weight, const DObjSkelMat *matrix, vec3_t output);
void XSurfaceTransformNormal43(const vec3_t normal, const DObjSkelMat *matrix, vec3_t output);
void XSurfaceTransformVectorRows43(const vec3_t vector, const DObjSkelMat *matrix, vec3_t output);
...
void MatrixMultiply34(const float left[3][4], const float right[3][4], float output[3][4]);
