...
#define COLLISION_TRACE_WORK_STATIC_ASSERT(expression, message) \
...
#define COLLISION_TRACE_WORK_ASSERT_FIELD(type, field, offset)             \
    COLLISION_TRACE_WORK_STATIC_ASSERT(                                   \
        offsetof(type, field) == (offset), #type "." #field " offset")

COLLISION_TRACE_WORK_STATIC_ASSERT(
    COLLISION_TRACE_WORK_ALIGNOF(sphere_t) == 4, "sphere_t alignment");
...
COLLISION_TRACE_WORK_STATIC_ASSERT(sizeof(sphere_t) == 0x18,
                                   "sphere_t size");
...
COLLISION_TRACE_WORK_STATIC_ASSERT(sizeof(cmTraceSphereRecord_t) == 0x24,
                                   "cmTraceSphereRecord_t size");
...
COLLISION_TRACE_WORK_STATIC_ASSERT(sizeof(traceWork_t) == 0x118,
                                   "traceWork_t size");

COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointTraceStaticModelsWork_t, trace,
                                  0x00);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointTraceStaticModelsWork_t,
                                  contentsMask, 0x30);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointTraceStaticModelsWork_t, start,
                                  0x34);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointTraceStaticModelsWork_t, end, 0x40);
COLLISION_TRACE_WORK_STATIC_ASSERT(
    sizeof(cmPointTraceStaticModelsWork_t) == 0x4c,
...
COLLISION_TRACE_WORK_STATIC_ASSERT(sizeof(cmClipMoveWork_t) == 0x7c,
                                   "cmClipMoveWork_t size");
...
COLLISION_TRACE_WORK_ASSERT_FIELD(cmClipSightTraceWork_t, expandedHalfSize,
                                  0x18);
...
COLLISION_TRACE_WORK_ASSERT_FIELD(cmClipSightTraceWork_t, passEntityNum,
                                  0x3c);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmClipSightTraceWork_t, passOwnerNum, 0x40);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmClipSightTraceWork_t,
                                  passEntityOwnerNum, 0x44);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmClipSightTraceWork_t,
                                  passOwnerOwnerNum, 0x48);
...
COLLISION_TRACE_WORK_STATIC_ASSERT(sizeof(cmClipSightTraceWork_t) == 0x54,
                                   "cmClipSightTraceWork_t size");
...
COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointTraceWork_t, dobjTracePartState,
                                  0x58);
COLLISION_TRACE_WORK_STATIC_ASSERT(sizeof(cmPointTraceWork_t) == 0x5c,
                                   "cmPointTraceWork_t size");
...
COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointSightTraceWork_t, passEntityNum,
                                  0x18);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointSightTraceWork_t, passOwnerNum,
                                  0x1c);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointSightTraceWork_t,
                                  passEntityOwnerNum, 0x20);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointSightTraceWork_t,
                                  passOwnerOwnerNum, 0x24);
COLLISION_TRACE_WORK_ASSERT_FIELD(cmPointSightTraceWork_t, contentsMask, 0x28);
COLLISION_TRACE_WORK_STATIC_ASSERT(sizeof(cmPointSightTraceWork_t) == 0x2c,
                                   "cmPointSightTraceWork_t size");

COLLISION_TRACE_WORK_ASSERT_FIELD(cmSightTraceStaticModelsWork_t,
                                  contentsMask, 0x00);
...
COLLISION_TRACE_WORK_STATIC_ASSERT(
    sizeof(cmSightTraceStaticModelsWork_t) == 0x1c,
