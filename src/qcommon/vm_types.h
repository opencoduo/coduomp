...
#define VM_TYPES_STATIC_ASSERT(expression, message) \
...
typedef intptr_t (VM_CDECL *vmMain_t)(
...
VM_TYPES_STATIC_ASSERT(VM_TYPES_ALIGNOF(vm_t) == 4,
                       "i386 VM record alignment changed");
VM_TYPES_STATIC_ASSERT(offsetof(vm_t, systemCall) == 0x00,
                       "i386 VM system-call entry moved");
VM_TYPES_STATIC_ASSERT(offsetof(vm_t, name) == 0x04,
                       "i386 VM name moved");
VM_TYPES_STATIC_ASSERT(sizeof(((vm_t *)0)->name) == 0x40,
                       "i386 VM name extent changed");
VM_TYPES_STATIC_ASSERT(offsetof(vm_t, loadedPath) == 0x44,
                       "i386 VM loaded path moved");
VM_TYPES_STATIC_ASSERT(sizeof(((vm_t *)0)->loadedPath) == 0x40,
                       "i386 VM loaded-path extent changed");
VM_TYPES_STATIC_ASSERT(offsetof(vm_t, unused84) == 0x84,
                       "i386 VM unused lane moved");
VM_TYPES_STATIC_ASSERT(offsetof(vm_t, libraryHandle) == 0x88,
                       "i386 VM library handle moved");
VM_TYPES_STATIC_ASSERT(offsetof(vm_t, vmMain) == 0x8c,
                       "i386 VM entry point moved");
VM_TYPES_STATIC_ASSERT(sizeof(vm_t) == 0x90,
                       "i386 VM record stride changed");
#endif
