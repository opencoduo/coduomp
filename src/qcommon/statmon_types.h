...
typedef char q_statmon_expire_time_offset[offsetof(statmon_entry_t, expireTime) == 0x00 ? 1 : -1];
typedef char q_statmon_shader_handle_offset[offsetof(statmon_entry_t, shaderHandle) == 0x04 ? 1 : -1];
typedef char q_statmon_entry_size[sizeof(statmon_entry_t) == 0x08 ? 1 : -1];
