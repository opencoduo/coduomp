...
#define UI_NATIVE_SYSCALL_1(a0) \
    ui_syscall_vector((intptr_t[]){(intptr_t)(a0)})
#define UI_NATIVE_SYSCALL_2(a0, a1) \
    ui_syscall_vector((intptr_t[]){(intptr_t)(a0), (intptr_t)(a1)})
#define UI_NATIVE_SYSCALL_3(a0, a1, a2) \
    ui_syscall_vector((intptr_t[]){(intptr_t)(a0), (intptr_t)(a1), \
                                   (intptr_t)(a2)})
#define UI_NATIVE_SYSCALL_4(a0, a1, a2, a3) \
    ui_syscall_vector((intptr_t[]){(intptr_t)(a0), (intptr_t)(a1), \
...
#define UI_NATIVE_SYSCALL_13(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12) \
    ui_syscall_vector((intptr_t[]){(intptr_t)(a0), (intptr_t)(a1), \
                                   ...
                                   (intptr_t)(a10), (intptr_t)(a11), \
                                   (intptr_t)(a12)})
#define UI_NATIVE_SYSCALL_SELECT( \
    _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, name, ...) \
    name
#define ui_syscall(...) \
    UI_NATIVE_SYSCALL_SELECT( \
        __VA_ARGS__, UI_NATIVE_SYSCALL_13, UI_NATIVE_SYSCALL_12, \
        UI_NATIVE_SYSCALL_11, UI_NATIVE_SYSCALL_10, \
        UI_NATIVE_SYSCALL_9, UI_NATIVE_SYSCALL_8, \
        UI_NATIVE_SYSCALL_7, UI_NATIVE_SYSCALL_6, \
        UI_NATIVE_SYSCALL_5, UI_NATIVE_SYSCALL_4, \
        UI_NATIVE_SYSCALL_3, UI_NATIVE_SYSCALL_2, \
        UI_NATIVE_SYSCALL_1)(__VA_ARGS__)
#endif
...
int32_t trap_FS_FOpenFile(const char *filename, int32_t *handle,
                          fsMode_t mode);
