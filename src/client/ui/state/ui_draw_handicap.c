 ...
 * 0x40040300. */
const char *const ui_handicapLabels[22] = {NULL, "None", "95", "90", "85", "80", "75", "70", "65", "60", "55",
                                           "50", "45",   "40", "35", "30", "25", "20", "15", "10", "5",  NULL};
...
void UI_DrawHandicap(const rectDef_t *rect, int32_t font, float scale, const vec4_t color, int32_t textStyle)
{
    ...
    labelIndex = coduo_fp_to_i32_extended((long double)handicap) / UI_HANDICAP_STEP;
    trap_R_Text_Paint(rect->x, rect->y, font, scale, color, ui_handicapLabels[21 - labelIndex], 0, 0, textStyle);
}
