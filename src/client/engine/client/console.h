...
_Static_assert(_Alignof(console_state_t) == 0x4, "console_state_t original alignment");
_Static_assert(offsetof(console_state_t, initialized) == 0x00000, "console_state_t initialized offset");
_Static_assert(sizeof(((console_state_t *)0)->initialized) == 0x00004, "console_state_t initialized extent");
_Static_assert(offsetof(console_state_t, text) == 0x00004, "console_state_t text offset");
_Static_assert(sizeof(((console_state_t *)0)->text) == 0x20000, "console_state_t text extent");
_Static_assert(offsetof(console_state_t, currentLine) == 0x20004, "console_state_t currentLine offset");
_Static_assert(sizeof(((console_state_t *)0)->currentLine) == 0x00004, "console_state_t currentLine extent");
_Static_assert(offsetof(console_state_t, lineCursor) == 0x20008, "console_state_t lineCursor offset");
_Static_assert(sizeof(((console_state_t *)0)->lineCursor) == 0x00004, "console_state_t lineCursor extent");
_Static_assert(offsetof(console_state_t, displayLine) == 0x2000c, "console_state_t displayLine offset");
_Static_assert(sizeof(((console_state_t *)0)->displayLine) == 0x00004, "console_state_t displayLine extent");
_Static_assert(offsetof(console_state_t, lastMessageDestination) == 0x20010, "console_state_t lastMessageDestination offset");
_Static_assert(sizeof(((console_state_t *)0)->lastMessageDestination) == 0x00004, "console_state_t lastMessageDestination extent");
_Static_assert(offsetof(console_state_t, lineWidth) == 0x20014, "console_state_t lineWidth offset");
_Static_assert(sizeof(((console_state_t *)0)->lineWidth) == 0x00004, "console_state_t lineWidth extent");
_Static_assert(offsetof(console_state_t, totalLines) == 0x20018, "console_state_t totalLines offset");
_Static_assert(sizeof(((console_state_t *)0)->totalLines) == 0x00004, "console_state_t totalLines extent");
_Static_assert(offsetof(console_state_t, xAdjust) == 0x2001c, "console_state_t xAdjust offset");
_Static_assert(sizeof(((console_state_t *)0)->xAdjust) == 0x00004, "console_state_t xAdjust extent");
_Static_assert(offsetof(console_state_t, displayFrac) == 0x20020, "console_state_t displayFrac offset");
_Static_assert(sizeof(((console_state_t *)0)->displayFrac) == 0x00004, "console_state_t displayFrac extent");
_Static_assert(offsetof(console_state_t, finalFrac) == 0x20024, "console_state_t finalFrac offset");
_Static_assert(sizeof(((console_state_t *)0)->finalFrac) == 0x00004, "console_state_t finalFrac extent");
_Static_assert(offsetof(console_state_t, visiblePixelHeight) == 0x20028, "console_state_t visiblePixelHeight offset");
_Static_assert(sizeof(((console_state_t *)0)->visiblePixelHeight) == 0x00004, "console_state_t visiblePixelHeight extent");
_Static_assert(sizeof(console_state_t) == 0x2002c, "console_state_t original size");
