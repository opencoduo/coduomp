...
_Static_assert(_Alignof(cl_ping_t) == 4, "i386 pending-ping alignment changed");
_Static_assert(offsetof(cl_ping_t, address) == 0x000, "original pending-ping address offset");
_Static_assert(sizeof(((cl_ping_t *)0)->address) == 0x014, "original pending-ping address extent");
_Static_assert(offsetof(cl_ping_t, requestStartTime) == 0x014, "original pending-ping start-time offset");
_Static_assert(offsetof(cl_ping_t, pingMsec) == 0x018, "original pending-ping elapsed-time offset");
_Static_assert(offsetof(cl_ping_t, serverInfo) == 0x01c, "original pending-ping info-string offset");
_Static_assert(sizeof(((cl_ping_t *)0)->serverInfo) == 0x400, "original pending-ping info-string extent");
_Static_assert(sizeof(cl_ping_t) == 0x41c, "original pending-ping record extent");

_Static_assert(_Alignof(cl_server_status_t) == 4, "i386 server-status alignment changed");
_Static_assert(offsetof(cl_server_status_t, responseText) == 0x0000, "original server-status text offset");
_Static_assert(sizeof(((cl_server_status_t *)0)->responseText) == 0x2000, "original server-status text extent");
_Static_assert(offsetof(cl_server_status_t, address) == 0x2000, "original server-status address offset");
_Static_assert(sizeof(((cl_server_status_t *)0)->address) == 0x014, "original server-status address extent");
_Static_assert(offsetof(cl_server_status_t, responseReceivedTime) == 0x2014, "original server-status response-time offset");
_Static_assert(offsetof(cl_server_status_t, requestStartTime) == 0x2018, "original server-status start-time offset");
_Static_assert(offsetof(cl_server_status_t, requestPending) == 0x201c, "original server-status pending offset");
_Static_assert(offsetof(cl_server_status_t, printResponse) == 0x2020, "original server-status print offset");
_Static_assert(offsetof(cl_server_status_t, responseRetrieved) == 0x2024, "original server-status retrieved offset");
_Static_assert(sizeof(cl_server_status_t) == 0x2028, "original server-status record extent");

_Static_assert(_Alignof(lan_server_info_t) == 4, "i386 LAN server-record alignment changed");
_Static_assert(offsetof(lan_server_info_t, address) == 0x00, "original LAN server address offset");
_Static_assert(sizeof(((lan_server_info_t *)0)->address) == 0x14, "original LAN server address extent");
_Static_assert(offsetof(lan_server_info_t, netType) == 0x14, "original LAN server network-type offset");
_Static_assert(offsetof(lan_server_info_t, clients) == 0x15, "original LAN server client-count offset");
_Static_assert(offsetof(lan_server_info_t, maxClients) == 0x16, "original LAN server client-limit offset");
_Static_assert(offsetof(lan_server_info_t, dirty) == 0x17, "original LAN server dirty offset");
_Static_assert(offsetof(lan_server_info_t, allowAnonymous) == 0x18, "original LAN server anonymous-access offset");
_Static_assert(offsetof(lan_server_info_t, passwordRequired) == 0x19, "original LAN server password-required offset");
_Static_assert(offsetof(lan_server_info_t, pure) == 0x1a, "original LAN server pure-server offset");
_Static_assert(offsetof(lan_server_info_t, friendlyFire) == 0x1b, "original LAN server friendly-fire offset");
_Static_assert(offsetof(lan_server_info_t, killCam) == 0x1c, "original LAN server kill-cam offset");
_Static_assert(offsetof(lan_server_info_t, consoleDisabled) == 0x1d, "original LAN server console-disabled offset");
_Static_assert(offsetof(lan_server_info_t, hardware) == 0x1e, "original LAN server hardware offset");
_Static_assert(offsetof(lan_server_info_t, mod) == 0x1f, "original LAN server mod offset");
_Static_assert(offsetof(lan_server_info_t, punkBuster) == 0x20, "original LAN server PunkBuster offset");
_Static_assert(offsetof(lan_server_info_t, masterResponseAge) == 0x21, "original LAN server master-response-age offset");
_Static_assert(offsetof(lan_server_info_t, minPing) == 0x22, "original LAN server minimum-ping offset");
_Static_assert(offsetof(lan_server_info_t, maxPing) == 0x24, "original LAN server maximum-ping offset");
_Static_assert(offsetof(lan_server_info_t, ping) == 0x26, "original LAN server ping offset");
_Static_assert(offsetof(lan_server_info_t, timeoutsAllowed) == 0x28, "original LAN server timeouts-allowed offset");
_Static_assert(offsetof(lan_server_info_t, jeepsAllowed) == 0x2a, "original LAN server jeeps-allowed offset");
_Static_assert(offsetof(lan_server_info_t, tanksAllowed) == 0x2c, "original LAN server tanks-allowed offset");
_Static_assert(offsetof(lan_server_info_t, hostName) == 0x2e, "original LAN server hostname offset");
_Static_assert(sizeof(((lan_server_info_t *)0)->hostName) == 0x20, "original LAN server hostname extent");
_Static_assert(offsetof(lan_server_info_t, mapName) == 0x4e, "original LAN server map-name offset");
_Static_assert(sizeof(((lan_server_info_t *)0)->mapName) == 0x20, "original LAN server map-name extent");
_Static_assert(offsetof(lan_server_info_t, game) == 0x6e, "original LAN server game offset");
_Static_assert(sizeof(((lan_server_info_t *)0)->game) == 0x18, "original LAN server game extent");
_Static_assert(offsetof(lan_server_info_t, gameType) == 0x86, "original LAN server game-type offset");
_Static_assert(sizeof(((lan_server_info_t *)0)->gameType) == 0x12, "original LAN server game-type extent");
_Static_assert(sizeof(lan_server_info_t) == 0x98, "original LAN server record extent");
#endif
