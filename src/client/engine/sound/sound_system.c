...
typedef int32_t (AUDIO_CALLBACK *eax_manager_query_source_method_t)(
    ...
    float *occlusionRoomRatio, eax_source_query_workspace_t *workspace,
    qboolean updateState);

#if UINTPTR_MAX == UINT32_MAX
_Static_assert(_Alignof(eax_listener_properties_t) == 0x04,
               "i386 EAX listener-properties alignment changed");
_Static_assert(offsetof(eax_listener_properties_t, environment) == 0x00,
               "i386 EAX environment offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->environment) == 0x04,
               "i386 EAX environment extent changed");
_Static_assert(offsetof(eax_listener_properties_t, environmentSize) == 0x04,
               "i386 EAX environment-size offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->environmentSize) == 0x04,
               "i386 EAX environment-size extent changed");
_Static_assert(offsetof(eax_listener_properties_t, environmentDiffusion) == 0x08,
               "i386 EAX environment-diffusion offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->environmentDiffusion) == 0x04,
               "i386 EAX environment-diffusion extent changed");
_Static_assert(offsetof(eax_listener_properties_t, room) == 0x0c,
               "i386 EAX room offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->room) == 0x04,
               "i386 EAX room extent changed");
_Static_assert(offsetof(eax_listener_properties_t, roomHF) == 0x10,
               "i386 EAX room-HF offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->roomHF) == 0x04,
               "i386 EAX room-HF extent changed");
_Static_assert(offsetof(eax_listener_properties_t, roomLF) == 0x14,
               "i386 EAX room-LF offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->roomLF) == 0x04,
               "i386 EAX room-LF extent changed");
_Static_assert(offsetof(eax_listener_properties_t, decayTime) == 0x18,
               "i386 EAX decay-time offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->decayTime) == 0x04,
               "i386 EAX decay-time extent changed");
_Static_assert(offsetof(eax_listener_properties_t, decayHFRatio) == 0x1c,
               "i386 EAX decay-HF ratio offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->decayHFRatio) == 0x04,
               "i386 EAX decay-HF ratio extent changed");
_Static_assert(offsetof(eax_listener_properties_t, decayLFRatio) == 0x20,
               "i386 EAX decay-LF ratio offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->decayLFRatio) == 0x04,
               "i386 EAX decay-LF ratio extent changed");
_Static_assert(offsetof(eax_listener_properties_t, reflections) == 0x24,
               "i386 EAX reflections offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->reflections) == 0x04,
               "i386 EAX reflections extent changed");
_Static_assert(offsetof(eax_listener_properties_t, reflectionsDelay) == 0x28,
               "i386 EAX reflections-delay offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->reflectionsDelay) == 0x04,
               "i386 EAX reflections-delay extent changed");
_Static_assert(offsetof(eax_listener_properties_t, reflectionsPan) == 0x2c,
               "i386 EAX reflections-pan offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->reflectionsPan) == 0x0c,
               "i386 EAX reflections-pan extent changed");
_Static_assert(offsetof(eax_listener_properties_t, reverb) == 0x38,
               "i386 EAX reverb offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->reverb) == 0x04,
               "i386 EAX reverb extent changed");
_Static_assert(offsetof(eax_listener_properties_t, reverbDelay) == 0x3c,
               "i386 EAX reverb-delay offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->reverbDelay) == 0x04,
               "i386 EAX reverb-delay extent changed");
_Static_assert(offsetof(eax_listener_properties_t, reverbPan) == 0x40,
               "i386 EAX reverb-pan offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->reverbPan) == 0x0c,
               "i386 EAX reverb-pan extent changed");
_Static_assert(offsetof(eax_listener_properties_t, echoTime) == 0x4c,
               "i386 EAX echo-time offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->echoTime) == 0x04,
               "i386 EAX echo-time extent changed");
_Static_assert(offsetof(eax_listener_properties_t, echoDepth) == 0x50,
               "i386 EAX echo-depth offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->echoDepth) == 0x04,
               "i386 EAX echo-depth extent changed");
_Static_assert(offsetof(eax_listener_properties_t, modulationTime) == 0x54,
               "i386 EAX modulation-time offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->modulationTime) == 0x04,
               "i386 EAX modulation-time extent changed");
_Static_assert(offsetof(eax_listener_properties_t, modulationDepth) == 0x58,
               "i386 EAX modulation-depth offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->modulationDepth) == 0x04,
               "i386 EAX modulation-depth extent changed");
_Static_assert(offsetof(eax_listener_properties_t, airAbsorptionHF) == 0x5c,
               "i386 EAX air-absorption offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->airAbsorptionHF) == 0x04,
               "i386 EAX air-absorption extent changed");
_Static_assert(offsetof(eax_listener_properties_t, hfReference) == 0x60,
               "i386 EAX HF-reference offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->hfReference) == 0x04,
               "i386 EAX HF-reference extent changed");
_Static_assert(offsetof(eax_listener_properties_t, lfReference) == 0x64,
               "i386 EAX LF-reference offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->lfReference) == 0x04,
               "i386 EAX LF-reference extent changed");
_Static_assert(offsetof(eax_listener_properties_t, roomRolloffFactor) == 0x68,
               "i386 EAX room-rolloff offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->roomRolloffFactor) == 0x04,
               "i386 EAX room-rolloff extent changed");
_Static_assert(offsetof(eax_listener_properties_t, flags) == 0x6c,
               "i386 EAX flags offset changed");
_Static_assert(sizeof(((eax_listener_properties_t *)0)->flags) == 0x04,
               "i386 EAX flags extent changed");
_Static_assert(sizeof(eax_listener_properties_t) == 0x70,
               "original i386 EAX listener-properties size changed");

_Static_assert(_Alignof(eax_source_query_workspace_t) == 0x04,
               "i386 EAX source-workspace alignment changed");
_Static_assert(offsetof(eax_source_query_workspace_t, queriedPosition) == 0x00,
               "i386 EAX source-workspace position offset changed");
_Static_assert(sizeof(((eax_source_query_workspace_t *)0)->queriedPosition) == 0x0c,
               "i386 EAX source-workspace position extent changed");
_Static_assert(offsetof(eax_source_query_workspace_t, unused0c) == 0x0c,
               "i386 EAX source-workspace unused lane offset changed");
_Static_assert(sizeof(((eax_source_query_workspace_t *)0)->unused0c) == 0x0c,
               "i386 EAX source-workspace unused lane extent changed");
_Static_assert(offsetof(eax_source_query_workspace_t, scale) == 0x18,
               "i386 EAX source-workspace scale offset changed");
_Static_assert(sizeof(((eax_source_query_workspace_t *)0)->scale) == 0x04,
               "i386 EAX source-workspace scale extent changed");
_Static_assert(sizeof(eax_source_query_workspace_t) == 0x1c,
               "original i386 EAX source-workspace size changed");
#endif
...
typedef struct eax_manager_vtable_s {
    ...
    eax_manager_get_listener_position_method_t
        getListenerPosition; /* unused by CoDUOMP.exe */
    /* EaxMan.dll RVA 0x000025f0. */
    eax_manager_find_named_id_method_t
        findSourceId; /* unused by CoDUOMP.exe */
    /* EaxMan.dll RVA 0x00002610. */
    eax_manager_get_source_properties_method_t
        getSourceProperties; /* unused by CoDUOMP.exe */
    /* EaxMan.dll RVA 0x00002680. */
    eax_manager_get_source_position_count_method_t
        getSourcePositionCount; /* unused by CoDUOMP.exe */
    /* EaxMan.dll RVA 0x000026d0. */
    eax_manager_get_source_position_method_t
        getSourcePosition; /* unused by CoDUOMP.exe */
    /* EaxMan.dll RVA 0x00002560. */
    eax_manager_find_named_id_method_t
        findEnvironmentId; /* unused by CoDUOMP.exe */
    eax_manager_get_environment_method_t getEnvironment;
    /* EaxMan.dll RVA 0x00002750. */
    eax_manager_find_named_id_method_t
        findMaterialId; /* unused by CoDUOMP.exe */
    /* EaxMan.dll RVA 0x00002770. */
    eax_manager_get_material_properties_method_t
        getMaterialProperties; /* unused by CoDUOMP.exe */
    /* EaxMan.dll RVA 0x000027f0. */
    eax_manager_find_named_id_method_t
        findGeometryId; /* unused by CoDUOMP.exe */
...
#if UINTPTR_MAX == UINT32_MAX
_Static_assert(_Alignof(eax_manager_vtable_t) == 0x04,
               "i386 EAX manager-vtable alignment changed");
_Static_assert(offsetof(eax_manager_vtable_t, queryInterface) == 0x00,
               "i386 EAX QueryInterface slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->queryInterface) == 0x04,
               "i386 EAX QueryInterface slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, addRef) == 0x04,
               "i386 EAX AddRef slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->addRef) == 0x04,
               "i386 EAX AddRef slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, release) == 0x08,
               "i386 EAX Release slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->release) == 0x04,
               "i386 EAX Release slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, getLoadedDataSize) == 0x0c,
               "i386 EAX loaded-data-size slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->getLoadedDataSize) == 0x04,
               "i386 EAX loaded-data-size slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, loadEnvironment) == 0x10,
               "i386 EAX load-environment slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->loadEnvironment) == 0x04,
               "i386 EAX load-environment slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, clearEnvironment) == 0x14,
               "i386 EAX clear-environment slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->clearEnvironment) == 0x04,
               "i386 EAX clear-environment slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, getListenerPosition) == 0x18,
               "i386 EAX listener-position slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->getListenerPosition) == 0x04,
               "i386 EAX listener-position slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, findSourceId) == 0x1c,
               "i386 EAX source-lookup slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->findSourceId) == 0x04,
               "i386 EAX source-lookup slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, getSourceProperties) == 0x20,
               "i386 EAX source-properties slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->getSourceProperties) == 0x04,
               "i386 EAX source-properties slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, getSourcePositionCount) == 0x24,
               "i386 EAX source-position-count slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->getSourcePositionCount) == 0x04,
               "i386 EAX source-position-count slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, getSourcePosition) == 0x28,
               "i386 EAX source-position slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->getSourcePosition) == 0x04,
               "i386 EAX source-position slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, findEnvironmentId) == 0x2c,
               "i386 EAX environment-lookup slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->findEnvironmentId) == 0x04,
               "i386 EAX environment-lookup slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, getEnvironment) == 0x30,
               "i386 EAX get-environment slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->getEnvironment) == 0x04,
               "i386 EAX get-environment slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, findMaterialId) == 0x34,
               "i386 EAX material-lookup slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->findMaterialId) == 0x04,
               "i386 EAX material-lookup slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, getMaterialProperties) == 0x38,
               "i386 EAX material-properties slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->getMaterialProperties) == 0x04,
               "i386 EAX material-properties slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, findGeometryId) == 0x3c,
               "i386 EAX geometry-lookup slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->findGeometryId) == 0x04,
               "i386 EAX geometry-lookup slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, queryListener) == 0x40,
               "i386 EAX query-listener slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->queryListener) == 0x04,
               "i386 EAX query-listener slot extent changed");
_Static_assert(offsetof(eax_manager_vtable_t, querySource) == 0x44,
               "i386 EAX query-source slot changed");
_Static_assert(sizeof(((eax_manager_vtable_t *)0)->querySource) == 0x04,
               "i386 EAX query-source slot extent changed");
_Static_assert(sizeof(eax_manager_vtable_t) == 0x48,
               "original i386 EAX manager-vtable prefix size changed");

_Static_assert(_Alignof(eax_manager_t) == 0x04,
               "i386 EAX manager-interface alignment changed");
_Static_assert(offsetof(eax_manager_t, vtable) == 0x00,
               "i386 EAX manager vtable-pointer offset changed");
_Static_assert(sizeof(((eax_manager_t *)0)->vtable) == 0x04,
...
#if UINTPTR_MAX == UINT32_MAX
_Static_assert(_Alignof(mss_3d_channel_save_t) == 0x04,
               "i386 MSS 3D-channel save alignment changed");
_Static_assert(offsetof(mss_3d_channel_save_t, startFraction) == 0x00,
               "i386 MSS 3D-channel start-fraction offset changed");
_Static_assert(sizeof(((mss_3d_channel_save_t *)0)->startFraction) == 0x04,
               "i386 MSS 3D-channel start-fraction extent changed");
_Static_assert(offsetof(mss_3d_channel_save_t, aliasPitchScale) == 0x04,
               "i386 MSS 3D-channel pitch offset changed");
_Static_assert(sizeof(((mss_3d_channel_save_t *)0)->aliasPitchScale) == 0x04,
               "i386 MSS 3D-channel pitch extent changed");
_Static_assert(offsetof(mss_3d_channel_save_t, logicalVolume) == 0x08,
               "i386 MSS 3D-channel volume offset changed");
_Static_assert(sizeof(((mss_3d_channel_save_t *)0)->logicalVolume) == 0x04,
               "i386 MSS 3D-channel volume extent changed");
_Static_assert(offsetof(mss_3d_channel_save_t, position) == 0x0c,
               "i386 MSS 3D-channel position offset changed");
_Static_assert(sizeof(((mss_3d_channel_save_t *)0)->position) == 0x0c,
               "i386 MSS 3D-channel position extent changed");
_Static_assert(sizeof(mss_3d_channel_save_t) == 0x18,
               "i386 MSS 3D-channel save size changed");

_Static_assert(_Alignof(mss_2d_channel_save_t) == 0x04,
               "i386 MSS 2D-channel save alignment changed");
_Static_assert(offsetof(mss_2d_channel_save_t, startFraction) == 0x00,
               "i386 MSS 2D-channel start-fraction offset changed");
_Static_assert(sizeof(((mss_2d_channel_save_t *)0)->startFraction) == 0x04,
               "i386 MSS 2D-channel start-fraction extent changed");
_Static_assert(offsetof(mss_2d_channel_save_t, aliasPitchScale) == 0x04,
               "i386 MSS 2D-channel pitch offset changed");
_Static_assert(sizeof(((mss_2d_channel_save_t *)0)->aliasPitchScale) == 0x04,
               "i386 MSS 2D-channel pitch extent changed");
_Static_assert(offsetof(mss_2d_channel_save_t, logicalVolume) == 0x08,
               "i386 MSS 2D-channel volume offset changed");
_Static_assert(sizeof(((mss_2d_channel_save_t *)0)->logicalVolume) == 0x04,
               "i386 MSS 2D-channel volume extent changed");
_Static_assert(offsetof(mss_2d_channel_save_t, pan) == 0x0c,
               "i386 MSS 2D-channel pan offset changed");
_Static_assert(sizeof(((mss_2d_channel_save_t *)0)->pan) == 0x04,
               "i386 MSS 2D-channel pan extent changed");
_Static_assert(sizeof(mss_2d_channel_save_t) == 0x10,
               "i386 MSS 2D-channel save size changed");

_Static_assert(_Alignof(mss_stream_channel_save_t) == 0x04,
               "i386 MSS stream-channel save alignment changed");
_Static_assert(offsetof(mss_stream_channel_save_t, startFraction) == 0x00,
               "i386 MSS stream start-fraction offset changed");
_Static_assert(sizeof(((mss_stream_channel_save_t *)0)->startFraction) == 0x04,
               "i386 MSS stream start-fraction extent changed");
_Static_assert(offsetof(mss_stream_channel_save_t, basePlaybackRate) == 0x04,
               "i386 MSS stream playback-rate offset changed");
_Static_assert(sizeof(((mss_stream_channel_save_t *)0)->basePlaybackRate) == 0x04,
               "i386 MSS stream playback-rate extent changed");
_Static_assert(offsetof(mss_stream_channel_save_t, logicalVolume) == 0x08,
               "i386 MSS stream volume offset changed");
_Static_assert(sizeof(((mss_stream_channel_save_t *)0)->logicalVolume) == 0x04,
               "i386 MSS stream volume extent changed");
_Static_assert(offsetof(mss_stream_channel_save_t, relativeVolume) == 0x0c,
               "i386 MSS stream sample-volume offset changed");
_Static_assert(sizeof(((mss_stream_channel_save_t *)0)->relativeVolume) == 0x04,
               "i386 MSS stream sample-volume extent changed");
_Static_assert(offsetof(mss_stream_channel_save_t, pan) == 0x10,
               "i386 MSS stream pan offset changed");
_Static_assert(sizeof(((mss_stream_channel_save_t *)0)->pan) == 0x04,
               "i386 MSS stream pan extent changed");
_Static_assert(offsetof(mss_stream_channel_save_t, position) == 0x14,
               "i386 MSS stream position offset changed");
_Static_assert(sizeof(((mss_stream_channel_save_t *)0)->position) == 0x0c,
               "i386 MSS stream position extent changed");
_Static_assert(sizeof(mss_stream_channel_save_t) == 0x20,
               "i386 MSS stream-channel save size changed");

_Static_assert(_Alignof(mss_environment_save_t) == 0x04,
               "i386 MSS environment save alignment changed");
_Static_assert(offsetof(mss_environment_save_t, roomType) == 0x00,
               "i386 MSS environment room-type offset changed");
_Static_assert(sizeof(((mss_environment_save_t *)0)->roomType) == 0x04,
               "i386 MSS environment room-type extent changed");
_Static_assert(offsetof(mss_environment_save_t, reverbLevel) == 0x04,
               "i386 MSS environment reverb-level offset changed");
_Static_assert(sizeof(((mss_environment_save_t *)0)->reverbLevel) == 0x04,
               "i386 MSS environment reverb-level extent changed");
_Static_assert(offsetof(mss_environment_save_t, reverbTarget) == 0x08,
               "i386 MSS environment reverb-target offset changed");
_Static_assert(sizeof(((mss_environment_save_t *)0)->reverbTarget) == 0x04,
               "i386 MSS environment reverb-target extent changed");
_Static_assert(offsetof(mss_environment_save_t, reverbRatePerMsec) == 0x0c,
               "i386 MSS environment reverb-rate offset changed");
_Static_assert(sizeof(((mss_environment_save_t *)0)->reverbRatePerMsec) == 0x04,
               "i386 MSS environment reverb-rate extent changed");
_Static_assert(sizeof(mss_environment_save_t) == 0x10,
...
mss_background_fade_t
    mss_backgroundFades[MSS_ALIAS_STREAM_SLOT_FIRST]; /* 0x009cbf6c */
...
mss_channel_info_t
    mss_channelInfo[MSS_TOTAL_CHANNEL_COUNT]; /* original 0x009cbfe8 */
mss_stream_channel_t
    mss_streamChannels[MSS_STREAM_CHANNEL_CAPACITY]; /* original 0x009cd1f4 */
...
{
    if (fileData == NULL || expectedForm == NULL ||
    ...
    if (memcmp(bytes, "RIFF", MSS_RIFF_FOURCC_BYTES) != 0 ||
        memcmp(bytes + MSS_RIFF_FORM_OFFSET, expectedForm,
               MSS_RIFF_FOURCC_BYTES) != 0) {
        return qfalse;
    }

    const uint32_t riffSize =
        (uint32_t)bytes[MSS_RIFF_SIZE_OFFSET] |
        ((uint32_t)bytes[MSS_RIFF_SIZE_OFFSET + 1] << 8) |
        ((uint32_t)bytes[MSS_RIFF_SIZE_OFFSET + 2] << 16) |
        ((uint32_t)bytes[MSS_RIFF_SIZE_OFFSET + 3] << 24);
    const uint32_t loadedLength = (uint32_t)fileLength;
    if (riffSize < MSS_RIFF_FOURCC_BYTES ||
        riffSize > loadedLength - MSS_RIFF_CHUNK_HEADER_BYTES) {
        return qfalse;
    }
    ...
    qboolean payloadIsBounded =
        payloadChunkId == NULL ? qtrue : qfalse;
    ...
    while (offset < riffEnd) {
        ...
        const uint32_t chunkSize =
            (uint32_t)bytes[offset + MSS_RIFF_CHUNK_SIZE_OFFSET] |
        ...
        const uint32_t dataOffset =
            offset + MSS_RIFF_CHUNK_HEADER_BYTES;
        if (chunkSize > riffEnd - dataOffset)
            return qfalse;

        if (payloadChunkId != NULL &&
            memcmp(bytes + offset, payloadChunkId,
                   MSS_RIFF_FOURCC_BYTES) == 0 &&
            payload == (const void *)(bytes + dataOffset) &&
    ...
    const char *chunkId, coduompMssWavChunk_t *outChunk)
{
    ...
    while (offset < scanEnd) {
        if (offset > loadedLength ||
            loadedLength - offset < MSS_RIFF_CHUNK_HEADER_BYTES) {
            return qfalse;
        }
        ...
        const uint64_t nextOffset =
            (uint64_t)dataOffset + chunkSize + (chunkSize & 1u);
    ...
    audio_sound_info_t *soundInfo)
{
    ...
    if (formatTag == AUDIO_WAVE_FORMAT_PCM) {
        ...
        const uint32_t samplesPerFullBlock =
            1u + ((uint32_t)blockSize - imaHeaderSize) * 2u / channelCount;
        if (sampleRate == 0) {
            const uint64_t sampleRateNumerator =
        ...
        if (incompleteBlockSize != 0 &&
            ...
            const uint32_t stereoPayloadSize =
                incompleteBlockSize - imaHeaderSize;
            const uint32_t incompleteGroupSize =
                stereoPayloadSize % MSS_WAVE_IMA_STEREO_GROUP_BYTES;
        ...
        while (blockOffset < dataLength) {
            ...
            for (uint32_t channel = 0; channel < channelCount; ++channel) {
                const uint32_t stepIndexOffset =
                    blockOffset +
                    channel * MSS_WAVE_IMA_HEADER_BYTES_PER_CHANNEL +
        ...
        uint64_t maximumSampleCount =
            (uint64_t)fullBlockCount * samplesPerFullBlock;
...
{
    if (fileData == NULL || path == NULL || publicInfo == NULL ||
        fileLength < 0 || publicInfo->data == NULL) {
        return qfalse;
    }
    ...
    const uint32_t loadedLength = (uint32_t)fileLength;
    if (dataAddress < fileAddress ||
        dataAddress - fileAddress > loadedLength) {
        return qfalse;
    }
    ...
    const uint8_t *listData, uint32_t listSize)
{
    ...
    while (offset < listSize) {
        ...
        if (memcmp(listData + offset, "num ",
                   MSS_RIFF_FOURCC_BYTES) == 0) {
            if (countData != NULL || chunkSize != sizeof(uint32_t))
                return qfalse;
            countData = listData + dataOffset;
        } else if (memcmp(listData + offset, nameChunkId,
                          MSS_RIFF_FOURCC_BYTES) == 0) {
            if (foundNames)
                return qfalse;
            foundNames = qtrue;
            nameSize = chunkSize;
        } else if (memcmp(listData + offset, firstDataChunkId,
                          MSS_RIFF_FOURCC_BYTES) == 0) {
            if (foundFirstData)
                return qfalse;
            foundFirstData = qtrue;
            firstDataSize = chunkSize;
        } else if (secondDataChunkId != NULL &&
                   memcmp(listData + offset, secondDataChunkId,
                          MSS_RIFF_FOURCC_BYTES) == 0) {
            if (foundSecondData)
                return qfalse;
    ...
    if (countData == NULL || !foundNames || !foundFirstData ||
        !foundSecondData) {
        return qfalse;
    }
    ...
    if (recordCount > INT32_MAX ||
        ...
        firstDataSize % firstRecordSize != 0 ||
        firstDataSize / firstRecordSize != recordCount) {
        return qfalse;
    }

    if (geometryList) {
        return recordCount <=
                       secondDataSize / MSS_EAL_GEOMETRY_MINIMUM_BYTES
                   ? qtrue
                   : qfalse;
    }
    if (secondDataChunkId != NULL &&
        (secondDataSize % secondRecordSize != 0 ||
         secondDataSize / secondRecordSize != recordCount)) {
        return qfalse;
    }
    return qtrue;
}
    ...
    const void *fileData, int32_t fileLength)
{
    ...
    for (uint32_t offset = MSS_RIFF_FILE_HEADER_BYTES;
        ...
        } else if (memcmp(bytes + offset, "LIST",
                          MSS_RIFF_FOURCC_BYTES) == 0) {
    ...
    return foundMajorVersion && foundMinorVersion && foundListenerAxis &&
                   foundDefaultGeometry && foundDefaultEnvironment &&
                   foundDefaultSource && foundDefaultMaterial &&
                   foundEnvironmentPool && foundSourcePool &&
                   foundMaterialPool && foundGeometryPool
               ? qtrue
               : qfalse;
}
...
void MSS_Init(void)
{
    ...
    mss_errorOnMissing =
        Cvar_Get("mss_errorOnMissing", "1", CVAR_ARCHIVE);
    ...
    for (int32_t channel = 0;
         channel < SND_ALIAS_CHANNEL_COUNT; ++channel) {
                  ...
                  size_t byteCount)
{
    ...
    if (offset < 0 || bufferSize < 0 ||
        byteCount > (size_t)bufferSize ||
        (size_t)offset > (size_t)bufferSize - byteCount) {
        Com_Error(ERR_DROP,
                  "\x15" "buffer overflow while saving sound state: "
                 ...
                 size_t byteCount)
{
    ...
    if (offset < 0 || bufferSize < 0 ||
        ...
        (size_t)offset > (size_t)bufferSize - byteCount) {
        Com_Error(ERR_DROP,
                  "\x15" "buffer overflow while restoring sound state: "
...
enum {
    ...
    MSS_SAVED_CHANNEL_INFO_BYTE_COUNT =
        MSS_SAVED_EFFECT_ID_BYTE_COUNT +
        MSS_SAVED_ALIAS_CHANNEL_BYTE_COUNT +
        sizeof(int32_t) + sizeof(float) + sizeof(float) + sizeof(vec3_t),
    MSS_SAVE_FIXED_STATE_BYTE_COUNT =
        sizeof(int32_t) + sizeof(mss_channelVolumes) +
        sizeof(mss_environment_save_t) +
        3 * sizeof(mss_backgroundFades[0]),
    MSS_SAVE_MAX_BYTE_COUNT =
        MSS_SAVE_FIXED_STATE_BYTE_COUNT +
        MSS_3D_CHANNEL_CAPACITY *
            (2 * sizeof(uint16_t) + MSS_SAVED_CHANNEL_INFO_BYTE_COUNT +
             sizeof(mss_3d_channel_save_t)) +
        MSS_2D_CHANNEL_CAPACITY *
            (2 * sizeof(uint16_t) + MSS_SAVED_CHANNEL_INFO_BYTE_COUNT +
             sizeof(mss_2d_channel_save_t)) +
        MSS_STREAM_CHANNEL_CAPACITY *
            (2 * sizeof(uint16_t) + MSS_SAVED_CHANNEL_INFO_BYTE_COUNT +
             sizeof(mss_stream_channel_save_t)) +
        3 * sizeof(uint16_t)
};
                         ...
                         const mss_channel_info_t *channelInfo)
{
    offset = MSS_Write(buffer, offset, bufferSize,
                       &channelInfo->effectId,
                       MSS_SAVED_EFFECT_ID_BYTE_COUNT);
    offset = MSS_Write(buffer, offset, bufferSize,
                       &channelInfo->aliasChannel,
                       MSS_SAVED_ALIAS_CHANNEL_BYTE_COUNT);
    offset = MSS_Write(buffer, offset, bufferSize,
                       &channelInfo->endTime,
                       sizeof(channelInfo->endTime));
    offset = MSS_Write(buffer, offset, bufferSize,
                       &channelInfo->logicalVolume,
                       sizeof(channelInfo->logicalVolume));
    offset = MSS_Write(buffer, offset, bufferSize,
                       &channelInfo->aliasBlend,
                       sizeof(channelInfo->aliasBlend));
    return MSS_Write(buffer, offset, bufferSize,
                     channelInfo->effectOffset,
                     sizeof(channelInfo->effectOffset));
}
                            ...
                            mss_channel_info_t *channelInfo)
{
    ...
    offset = MSS_Read(buffer, offset, bufferSize,
                      &channelInfo->effectId,
                      MSS_SAVED_EFFECT_ID_BYTE_COUNT);
    offset = MSS_Read(buffer, offset, bufferSize,
                      &channelInfo->aliasChannel,
    ...
    offset = MSS_Read(buffer, offset, bufferSize,
                      &channelInfo->aliasBlend,
                      sizeof(channelInfo->aliasBlend));
    return MSS_Read(buffer, offset, bufferSize,
                    channelInfo->effectOffset,
                    sizeof(channelInfo->effectOffset));
}
                          ...
                          int32_t bufferSize, int32_t channelIndex)
{
    ...
    if (primaryAliasIndex == 0)
        return offset;
    const uint16_t secondaryAliasIndex = (uint16_t)
        Com_SoundAliasIndex(channel->secondaryAlias, SND_ALIAS_BANK_CGAME);
    ...
    offset = MSS_Write(buffer, offset, bufferSize,
                       &primaryAliasIndex, sizeof(primaryAliasIndex));
    offset = MSS_Write(buffer, offset, bufferSize,
                       &secondaryAliasIndex, sizeof(secondaryAliasIndex));
    offset = MSS_SaveChanInfo(buffer, offset, bufferSize, channel);
    return MSS_Write(buffer, offset, bufferSize,
                     &savedState, sizeof(savedState));
}
                             ...
                             int32_t primaryAliasIndex)
{
    ...
    offset = MSS_Read(buffer, offset, bufferSize,
                      &secondaryAliasIndex,
                      sizeof(secondaryAliasIndex));
    offset = MSS_RestoreChanInfo(
        buffer, offset, bufferSize, &savedChannel);
    offset = MSS_Read(buffer, offset, bufferSize,
                      &savedState, sizeof(savedState));

    snd_alias_t *const primaryAlias =
        Com_GetSoundAlias(primaryAliasIndex, SND_ALIAS_BANK_CGAME);
    snd_alias_t *const secondaryAlias =
        Com_GetSoundAlias(secondaryAliasIndex, SND_ALIAS_BANK_CGAME);
    /* NOT_FROM_ORIGINAL_SOURCE: preserve this recovered boundary's validated input, state, and compatibility invariants. */
    if ((uint32_t)savedChannel.effectId >=
            (uint32_t)MSS_EFFECT_ID_LIMIT ||
        primaryAlias == NULL || secondaryAlias == NULL ||
        primaryAlias->type != SND_ALIAS_TYPE_LOADED ||
        secondaryAlias->type != SND_ALIAS_TYPE_LOADED ||
        primaryAlias->soundFileInfo == NULL ||
        secondaryAlias->soundFileInfo != primaryAlias->soundFileInfo ||
        !MSS_ValidateSoundAliasBlend(
            primaryAlias, secondaryAlias, qfalse)) {
        return offset;
    }
    ...
    (void)MSS_StartAlias3DSample(
        ...
        savedChannel.effectId, savedState.logicalVolume,
        savedState.aliasPitchScale,
        0, savedState.startFraction);
    if (channelIndex >= 0) {
        memcpy(mss_channelInfo[channelIndex].effectOffset,
               savedChannel.effectOffset,
               sizeof(savedChannel.effectOffset));
    }
    return offset;
}
                             ...
                             int32_t primaryAliasIndex)
{
    ...
    offset = MSS_Read(buffer, offset, bufferSize,
                      &discardedSecondaryAliasIndex,
                      sizeof(discardedSecondaryAliasIndex));
    offset = MSS_RestoreChanInfo(
        buffer, offset, bufferSize, &savedChannel);
    offset = MSS_Read(buffer, offset, bufferSize,
                      &savedState, sizeof(savedState));
    ...
    snd_alias_t *const secondaryAlias =
        Com_GetSoundAlias(primaryAliasIndex, SND_ALIAS_BANK_CGAME);
    if (primaryAlias == NULL || secondaryAlias == NULL ||
        primaryAlias->type != SND_ALIAS_TYPE_LOADED ||
        secondaryAlias->type != SND_ALIAS_TYPE_LOADED ||
        primaryAlias->soundFileInfo == NULL ||
        secondaryAlias->soundFileInfo != primaryAlias->soundFileInfo ||
                              ...
                              int32_t channelIndex)
{
    if (channelIndex < MSS_ALIAS_STREAM_CHANNEL_FIRST) {
        if (channelIndex ==
                MSS_STREAM_CHANNEL_FIRST +
                    MSS_AMBIENT_BACKGROUND_FIRST_INDEX ||
            channelIndex ==
                MSS_STREAM_CHANNEL_FIRST +
                    MSS_AMBIENT_BACKGROUND_SECOND_INDEX) {
            return offset;
                                 ...
                                 int32_t requestedChannelIndex)
{
    ...
    snd_alias_t *const secondaryAlias =
        Com_GetSoundAlias(primaryAliasIndex, SND_ALIAS_BANK_CGAME);
    if (primaryAlias == NULL || secondaryAlias == NULL ||
        primaryAlias->type != SND_ALIAS_TYPE_STREAMED ||
        secondaryAlias->type != SND_ALIAS_TYPE_STREAMED ||
        /* NOT_FROM_ORIGINAL_SOURCE: preserve this recovered boundary's validated input, state, and compatibility invariants. */
        (MSS_IsAliasChannel3D(primaryAlias->channel) &&
         (uint32_t)savedChannel.effectId >=
             (uint32_t)MSS_EFFECT_ID_LIMIT) ||
        !MSS_ValidateSoundAliasBlend(
            primaryAlias, secondaryAlias, qfalse)) {
        return offset;
    ...
    if (requestedChannelIndex < 0) {
        durationMsec = MSS_StartAliasStream(
            &channelIndex, primaryAlias, secondaryAlias,
            savedChannel.aliasBlend, savedChannel.effectId,
            savedState.position, savedState.logicalVolume,
            MSS_FULL_VOLUME, 0, savedState.startFraction);
    } else {
        durationMsec = MSS_StartAliasStreamOnChannel(
            primaryAlias, secondaryAlias, savedChannel.aliasBlend,
            savedChannel.effectId, savedState.position,
            savedState.logicalVolume, MSS_FULL_VOLUME, 0,
            savedState.startFraction, requestedChannelIndex);
    }
...
{
    int32_t offset = 0;
    const int32_t aliasChecksum =
        Com_SoundAliasChecksum(SND_ALIAS_BANK_CGAME);
    offset = MSS_Write(saveData, offset, saveCapacity,
                       &aliasChecksum, sizeof(aliasChecksum));
    offset = MSS_Write(saveData, offset, saveCapacity,
                       mss_channelVolumes,
                       sizeof(mss_channelVolumes));

    const mss_environment_save_t environment = {
        mss_roomType,
        mss_reverbLevel,
        mss_reverbTarget,
        mss_reverbRate
    ...
    offset = MSS_Write(saveData, offset, saveCapacity,
                       ...
                       sizeof(mss_backgroundFades[0]));
    offset = MSS_Write(saveData, offset, saveCapacity,
                       &mss_backgroundFades[3],
                       sizeof(mss_backgroundFades[3]));
    offset = MSS_Write(saveData, offset, saveCapacity,
                       &mss_backgroundFades[4],
                       sizeof(mss_backgroundFades[4]));

    if (mss_digitalDriver != NULL) {
        for (int32_t channelIndex = 0;
             channelIndex < mss_max3DChannels; ++channelIndex) {
            offset = MSS_Save3DChannel(
                saveData, offset, saveCapacity, channelIndex);
        }
    }
    const uint16_t listTerminator = 0;
    offset = MSS_Write(saveData, offset, saveCapacity,
                       &listTerminator, sizeof(listTerminator));

    if (mss_digitalDriver != NULL) {
        const int32_t end2DChannel =
            MSS_2D_CHANNEL_FIRST + mss_2dChannelCount;
        for (int32_t channelIndex = MSS_2D_CHANNEL_FIRST;
             channelIndex < end2DChannel; ++channelIndex) {
            offset = MSS_Save2DChannel(
                saveData, offset, saveCapacity, channelIndex);
        }
    }
    offset = MSS_Write(saveData, offset, saveCapacity,
    ...
    if (mss_digitalDriver != NULL) {
        const int32_t endStreamChannel =
            MSS_STREAM_CHANNEL_FIRST + mss_streamChannelCount;
        for (int32_t channelIndex = MSS_STREAM_CHANNEL_FIRST;
             channelIndex < endStreamChannel; ++channelIndex) {
            offset = MSS_SaveStreamChannel(
                saveData, offset, saveCapacity, channelIndex);
        }
    }
    return MSS_Write(saveData, offset, saveCapacity,
                     &listTerminator, sizeof(listTerminator));
}
...
void MSS_Restore(const uint8_t *saveData, int32_t saveSize)
{
    ...
    int32_t offset = MSS_Read(
        saveData, 0, saveSize,
        &savedAliasChecksum, sizeof(savedAliasChecksum));
    if (savedAliasChecksum !=
        Com_SoundAliasChecksum(SND_ALIAS_BANK_CGAME)) {
        Com_Printf(
            "^3Couldn't restore sound state: sound aliases have changed "
            "since saving.\n");
        return;
    }
    ...
    for (;;) {
        ...
        offset = MSS_Read(saveData, offset, saveSize,
                          &primaryAliasIndex,
                          sizeof(primaryAliasIndex));
        if (primaryAliasIndex == 0)
            break;
        offset = MSS_Restore3DChannel(
            saveData, offset, saveSize, primaryAliasIndex);
    }
    ...
    for (;;) {
        ...
        if (primaryAliasIndex == 0)
            break;
        offset = MSS_Restore2DChannel(
            saveData, offset, saveSize, primaryAliasIndex);
    }

    for (int32_t backgroundIndex = 0;
         backgroundIndex < MSS_ALIAS_STREAM_SLOT_FIRST;
         ++backgroundIndex) {
        if (backgroundIndex == MSS_AMBIENT_BACKGROUND_FIRST_INDEX ||
            backgroundIndex == MSS_AMBIENT_BACKGROUND_SECOND_INDEX) {
            continue;
        }
        uint16_t primaryAliasIndex = 0;
        offset = MSS_Read(saveData, offset, saveSize,
                          ...
                          sizeof(primaryAliasIndex));
        if (primaryAliasIndex != 0) {
            offset = MSS_RestoreStreamChannel(
                saveData, offset, saveSize, primaryAliasIndex,
                MSS_STREAM_CHANNEL_FIRST + backgroundIndex);
        }
    }
    ...
    for (;;) {
        ...
        if (primaryAliasIndex == 0)
            break;
        offset = MSS_RestoreStreamChannel(
            saveData, offset, saveSize, primaryAliasIndex, -1);
    }

    if (offset != saveSize) {
        Com_Error(
            ERR_DROP,
            "\x15" "sound state buffer size too big; probably due to an "
...
void MSS_QueueRestore(const uint8_t *saveData, int32_t saveSize)
{
    ...
    if (saveData == NULL || saveSize <= 0 ||
        saveSize > MSS_SAVE_MAX_BYTE_COUNT) {
        Com_Error(
            ERR_DROP,
            "\x15" "invalid queued sound state size: %i bytes\n",
            saveSize);
        return;
    }

    MSS_StopSounds(
        MSS_STOP_PRESERVE_MUSIC | MSS_STOP_PRESERVE_AMBIENT);
    if (mss_restoreBuffer != NULL)
        Z_FreeInternal(mss_restoreBuffer);
                              ...
                              int32_t maxCount)
{
    ...
    for (int32_t index = 0; index < maxCount; ++index) {
        ...
        entry->pitchScale = (float)(
            (long double)playbackRate /
            (long double)channel->basePlaybackRate);
    }
    return maxCount;
}
                              ...
                              int32_t maxCount)
{
    ...
    for (int32_t channelIndex = 0;
         channelIndex < maxCount; ++channelIndex) {
        ...
        const float basePlaybackRateFloat =
            (float)channel->basePlaybackRate;
        entry->pitchScale = (float)(
            (long double)playbackRateFloat /
...
void InitEAXManager(void)
{
    ...
    if (mss_eaxAvailable) {
        ...
        if (mss_eaxLibrary != NULL) {
            ...
            coduomp_library_symbol(mss_eaxLibrary, "EaxManagerCreate",
                                   &createManager,
                                   sizeof(createManager));
            if (createManager != NULL &&
                createManager(&mss_eaxManager) == MSS_EAX_RESULT_OK) {
                const cvar_t *const mapNameCvar = Cvar_FindVar("mapname");
                const char *const mapName =
                    mapNameCvar != NULL ? mapNameCvar->string : "";
                const size_t mapNameLength = strlen(mapName);
                if (mss_eaxMapNameWasTruncated !=
                        (mapNameLength >= sizeof(mss_eaxMapName)) ||
                    (mapNameLength >= sizeof(mss_eaxMapName)
                         ? strncmp(mss_eaxMapName, mapName,
                                   sizeof(mss_eaxMapName) - 1) != 0
                         : strcmp(mss_eaxMapName, mapName) != 0)) {
                    EALFileInit(mapName);
                    /* NOT_FROM_ORIGINAL_SOURCE: validate the loaded audio data and playback state before crossing the Miles boundary. */
                    Q_strncpyz(mss_eaxMapName, mapName,
                               sizeof(mss_eaxMapName));
                    mss_eaxMapNameWasTruncated =
                        mapNameLength >= sizeof(mss_eaxMapName);
                }
                return;
            }
...
void ReleaseEAXManager(void)
{
    ...
    if (mss_eaxEnvironmentLoaded) {
        (void)mss_eaxManager->vtable->clearEnvironment(
            mss_eaxManager, MSS_EAX_ENVIRONMENT_NONE);
        mss_eaxEnvironmentLoaded = qfalse;
    }
...
void EALFileInit(const char *mapName)
{
    ...
    if (strlen(strippedMapName) >
        sizeof(ealPath) - sizeof("eagle/") - sizeof(".eal") + 1) {
        Com_Printf("WARNING: ignoring overlong EAX environment path\n");
        mss_eaxEnvironmentLoaded = qfalse;
        return;
    }
    Com_sprintf(ealPath, sizeof(ealPath), "eagle/%s.eal",
                strippedMapName);
...
qboolean LoadEALFile(const char *path)
{
    ...
    if (fileData != NULL && fileLength != MSS_EAL_FILE_READ_FAILED) {
        ...
        const int32_t result = mss_eaxManager->vtable->loadEnvironment(
            mss_eaxManager, fileData, MSS_EAL_SOURCE_MEMORY);
        FS_FreeFile(fileData);
        return result == MSS_EAX_RESULT_OK ? qtrue : qfalse;
    }

    const int32_t result = mss_eaxManager->vtable->loadEnvironment(
        mss_eaxManager, path, MSS_EAL_SOURCE_PATH);
...
void UpdateEAXListener(const vec3_t origin)
{
    ...
    if (mss_eaxManager->vtable->queryListener(
            mss_eaxManager, MSS_EAX_LISTENER_ID, eaxPosition,
            &environmentId, qtrue) < MSS_EAX_RESULT_OK) {
        return;
    }
    ...
    eax_listener_properties_t properties;
    if (mss_eaxManager->vtable->getEnvironment(
            mss_eaxManager, environmentId,
            &properties) < MSS_EAX_RESULT_OK) {
        return;
    }
                     ...
                     const vec3_t position)
{
    ...
    if (mss_eaxManager->vtable->querySource(
            mss_eaxManager, MSS_EAX_SOURCE_ID, eaxPosition,
            &obstruction, &obstructionLFRatio,
            &occlusion, &occlusionLFRatio, &occlusionRoomRatio,
            &workspace, qfalse) != MSS_EAX_RESULT_OK) {
        return;
    }
...
qboolean MSS_Init2D(void)
{
    ...
    Com_Printf("2D provider initialized at %i %i %i\n", mss_sampleRate,
               mss_sampleBits, mss_channelCount);
    return qtrue;
}
...
#else
            Com_Printf(
                "trying to use 'Miles Fast 2D Positional Audio' instead of '%s'\n",
                preferredProviderName);
#endif
        }
...
void MSS_SetListener(int32_t time, const vec3_t origin, const axis_t axis)
{
    ...
    if (mss_eaxAvailable) {
        ...
        if (origin[0] != mss_listenerOrigin[0] ||
            origin[1] != mss_listenerOrigin[1] ||
            origin[2] != mss_listenerOrigin[2]) {
...
{
    const long double distancePastMinimum =
        (long double)distance - (long double)minimumDistance;
    if (distancePastMinimum <= (long double)0.0f)
        return (long double)1.0f;

    const long double attenuation =
        distancePastMinimum /
        ((long double)maximumDistance - (long double)minimumDistance);
                              ...
                              vec3_t worldPosition)
{
    ...
    vec3_t effectOrigin;
    axis_t effectAxis;
    (void)VM_Call(coduo_cgameVm, CGVM_GET_EFFECT_ORIGIN_AXIS,
                  effectId, (intptr_t)effectOrigin, (intptr_t)effectAxis,
                  0, 0, 0, 0, 0, 0, 0, 0, 0);

    const long double originAxisX =
        (long double)effectAxis[0][0] * (long double)localOffset[0] +
        (long double)effectOrigin[0];
    const long double originAxisY =
        (long double)effectAxis[0][1] * (long double)localOffset[0] +
        (long double)effectOrigin[1];
    const float firstTwoAxesX = (float)(
        (long double)effectAxis[1][0] * (long double)localOffset[1] +
        originAxisX);
    const float firstTwoAxesY = (float)(
        (long double)effectAxis[1][1] * (long double)localOffset[1] +
        originAxisY);

    const float originAxisZ = (float)(
        (long double)effectAxis[0][2] * (long double)localOffset[0] +
        (long double)effectOrigin[2]);
    const long double firstTwoAxesZ =
        (long double)effectAxis[1][2] * (long double)localOffset[1] +
        (long double)originAxisZ;

    const float resultX = (float)(
        (long double)effectAxis[2][0] * (long double)localOffset[2] +
        (long double)firstTwoAxesX);
    const float resultY = (float)(
        (long double)effectAxis[2][1] * (long double)localOffset[2] +
        (long double)firstTwoAxesY);
    const float resultZ = (float)(
        (long double)effectAxis[2][2] * (long double)localOffset[2] +
        firstTwoAxesZ);
                       ...
                       const vec3_t worldPosition)
{
    const long double deltaX =
        (long double)worldPosition[0] - (long double)mss_listenerOrigin[0];
    const long double deltaY =
        (long double)worldPosition[1] - (long double)mss_listenerOrigin[1];
    const long double deltaZ =
        (long double)worldPosition[2] - (long double)mss_listenerOrigin[2];

    float listenerCoordinates[3];
    for (int32_t axis = 0; axis < 3; ++axis) {
        listenerCoordinates[axis] = (float)(
            (long double)mss_listenerAxis[axis][2] * deltaZ +
            (long double)mss_listenerAxis[axis][1] * deltaY +
...
{
    const mss_channel_info_t *const first =
        &mss_channelInfo[firstChannelIndex];
    const mss_channel_info_t *const second =
        &mss_channelInfo[secondChannelIndex];
    ...
    const int32_t channelDifference = (int32_t)(
        (uint32_t)first->aliasChannel - (uint32_t)second->aliasChannel);
    if (channelDifference != 0)
        return channelDifference;
    return (int32_t)((uint32_t)first->endTime -
                     (uint32_t)second->endTime);
}
                                  ...
                                  sndAliasChannel_t maximumAliasChannel)
{
    ...
    for (int32_t channelIndex = firstChannelIndex;
        ...
        if (bestChannelIndex < 0 ||
            MSS_CompareReplacableChannels(channelIndex, bestChannelIndex,
                                           preferredEffectId) < 0) {
...
int32_t MSS_FindFree2DChannel(int32_t preferredEffectId,
                              sndAliasChannel_t maximumAliasChannel)
{
    for (int32_t sampleIndex = 0; sampleIndex < mss_2dChannelCount;
         ++sampleIndex) {
    ...
    const int32_t channelIndex = MSS_FindReplacableChannel(
        MSS_2D_CHANNEL_FIRST, mss_2dChannelCount, preferredEffectId,
        maximumAliasChannel);
    if (channelIndex > 0)
...
int32_t MSS_FindFree3DChannel(int32_t preferredEffectId,
                              sndAliasChannel_t maximumAliasChannel)
{
    for (int32_t channelIndex = MSS_3D_CHANNEL_FIRST;
         channelIndex < mss_max3DChannels;
         ++channelIndex) {
        if (MSS_Is3DChannelFree(channelIndex))
            return channelIndex;
    }
    ...
    const int32_t channelIndex = MSS_FindReplacableChannel(
        MSS_3D_CHANNEL_FIRST, mss_max3DChannels, preferredEffectId,
        maximumAliasChannel);
...
int32_t MSS_FindFreeStreamChannel(int32_t preferredEffectId,
                                  sndAliasChannel_t maximumAliasChannel)
{
    for (int32_t streamIndex = MSS_ALIAS_STREAM_SLOT_FIRST;
         streamIndex < mss_streamChannelCount; ++streamIndex) {
        const int32_t channelIndex =
            MSS_STREAM_CHANNEL_FIRST + streamIndex;
        if (MSS_IsStreamChannelFree(channelIndex))
            return channelIndex;
    }
    ...
    const int32_t channelIndex = MSS_FindReplacableChannel(
        ...
        mss_streamChannelCount - MSS_ALIAS_STREAM_SLOT_FIRST,
        preferredEffectId, maximumAliasChannel);
    if (channelIndex > 0)
                           ...
                           sndAliasChannel_t aliasChannel)
{
    for (int32_t channelIndex = MSS_3D_CHANNEL_FIRST;
        ...
        const mss_channel_info_t *const channel =
            &mss_channelInfo[channelIndex];
        if (channel->effectId == effectId &&
            channel->aliasChannel == aliasChannel &&
            !MSS_Is3DChannelFree(channelIndex)) {
            MSS_Stop3DChannel(channelIndex);
        }
    }

    const int32_t streamChannelEnd =
        MSS_STREAM_CHANNEL_FIRST + mss_streamChannelCount;
    for (int32_t channelIndex = MSS_STREAM_CHANNEL_FIRST;
         channelIndex < streamChannelEnd; ++channelIndex) {
        const mss_channel_info_t *const channel =
            &mss_channelInfo[channelIndex];
        if (channel->effectId == effectId &&
            channel->aliasChannel == aliasChannel &&
            !MSS_IsStreamChannelFree(channelIndex)) {
            MSS_StopStreamChannel(channelIndex);
        }
    }

    const int32_t channel2DEnd =
        MSS_2D_CHANNEL_FIRST + mss_2dChannelCount;
    for (int32_t channelIndex = MSS_2D_CHANNEL_FIRST;
         channelIndex < channel2DEnd; ++channelIndex) {
        const mss_channel_info_t *const channel =
            &mss_channelInfo[channelIndex];
        if (channel->effectId == effectId &&
            channel->aliasChannel == aliasChannel &&
            !MSS_Is2DChannelFree(channelIndex)) {
            MSS_Stop2DChannel(channelIndex);
        }
    }
}
...
{
    const int32_t channelIndex =
        MSS_FindFree2DChannel(effectId, alias->channel);
    ...
    if (startFraction != 0.0f) {
        const float scaledPosition =
            (float)((long double)durationMsec *
    ...
    if (alias->loop != 0)
        durationMsec = 0;
    MSS_SetChannelInfo(channelIndex, effectId, alias, secondaryAlias,
...
{
    const int32_t channelIndex =
        MSS_FindFree3DChannel(effectId, alias->channel);
    if (outChannelIndex != NULL)
        *outChannelIndex = channelIndex;
    if (channelIndex < 0)
        return qfalse;
    ...
    const float minimumDistance = (float)(
        (long double)oneMinusBlend * (long double)alias->distanceMin +
        (long double)aliasBlend *
            (long double)secondaryAlias->distanceMin);
    const float maximumDistance = (float)(
        (long double)oneMinusBlend * (long double)alias->distanceMax +
        (long double)aliasBlend *
    ...
    for (int32_t component = 0; component < 3; ++component) {
        listenerDelta[component] =
            mss_listenerOrigin[component] - position[component];
    }
    const float distance = (float)sqrtl(
        ((long double)listenerDelta[2] * listenerDelta[2] +
         (long double)listenerDelta[1] * listenerDelta[1]) +
        (long double)listenerDelta[0] * listenerDelta[0]);

    const float distancePastMinimum = (float)(
        (long double)distance - (long double)minimumDistance);
    float attenuation;
    if (distancePastMinimum <= 0.0f) {
        attenuation = 1.0f;
    } else {
        const float fraction = (float)(
            (long double)distancePastMinimum /
            ((long double)maximumDistance -
             (long double)minimumDistance));
        if (fraction >= 1.0f)
            attenuation = 0.0f;
        else
            attenuation = (float)((long double)1.0f -
                                  (long double)fraction);
    }
    const float attenuatedVolume = (float)(
    ...
    const float playbackRateFloat = (float)playbackRate;
    const float scaledDuration = (float)(
        (long double)scaledSampleCountFloat *
        (long double)mss_playbackRateScale /
        (long double)playbackRateFloat);
    ...
    if (startFraction != 0.0f) {
        ...
        const float scaledPosition =
            (float)((long double)durationMsecFloat *
                    (long double)startFraction);
        samplePositionMsec = FastRound(scaledPosition);
    } else {
        samplePositionMsec = timeShift;
                              ...
                              float pitch, int32_t timeShift)
{
    if (alias->soundFileInfo == NULL) {
        Com_DPrintf(
            "Tried to play sound '%s' from alias '%s', but it was not "
            "successfully loaded.\n",
    ...
    if (MSS_IsAliasChannel3D(alias->channel)) {
        return MSS_StartAlias3DSample(
            outChannelIndex, alias, position, secondaryAlias, aliasBlend,
            effectId, volume, pitch, timeShift, 0.0f);
    }

    return MSS_StartAlias2DSample(
        outChannelIndex, alias, secondaryAlias, aliasBlend, effectId,
        volume, pitch, timeShift, 0.0f);
}
    ...
    int32_t timeShift, float startFraction, int32_t channelIndex)
{
    ...
    *streamSlot = stream;
    ...
    mss_stream_channel_t *const streamChannel =
        &mss_streamChannels[streamIndex];
...
{
    const int32_t channelIndex =
        MSS_FindFreeStreamChannel(effectId, alias->channel);
    if (outChannelIndex != NULL)
        *outChannelIndex = channelIndex;
    if (channelIndex < 0)
        return 0;

    return MSS_StartAliasStreamOnChannel(
        alias, secondaryAlias, aliasBlend, effectId, position, volume,
        pitch, timeShift, startFraction, channelIndex);
}
    ...
    int32_t *outChannelIndex)
{
    ...
    for (int32_t channelIndex = MSS_3D_CHANNEL_FIRST;
        ...
        if (channel->effectId != effectId ||
            MSS_Is3DChannelFree(channelIndex) ||
            channel->alias->loop == 0 ||
            channel->alias->aliasName != alias->aliasName ||
            channel->secondaryAlias->aliasName !=
                secondaryAlias->aliasName) {
            continue;
        }

        const float oneMinusBlend =
            (float)((long double)1.0f - (long double)aliasBlend);
        channel->logicalVolume = (float)(
            ((long double)oneMinusBlend *
                 (long double)alias->volumeMin +
             (long double)aliasBlend *
                 (long double)secondaryAlias->volumeMin) *
            (long double)MSS_ALIAS_VOLUME_SCALE);
        if ((alias->pitchMin != 1.0f ||
             secondaryAlias->pitchMin != 1.0f) &&
            alias->pitchMin == alias->pitchMax &&
            secondaryAlias->pitchMin == secondaryAlias->pitchMax) {
            channel->aliasPitchScale = (float)(
                (long double)oneMinusBlend *
                    (long double)alias->pitchMin +
                (long double)aliasBlend *
                    (long double)secondaryAlias->pitchMin);
        }
    ...
    for (int32_t channelIndex = MSS_STREAM_CHANNEL_FIRST;
        ...
        audio_set_stream_playback_rate(
            ...
            FastRound(scaledPlaybackRate));
        for (int32_t component = 0; component < 3; ++component) {
            mss_streamChannels[streamIndex].position[component] =
                position[component];
        }
        channel->lastUpdateTime = mss_lastSoundTime;
        channel->aliasBlend = aliasBlend;
                              ...
                              float *outPitch)
{
    ...
    const float volumeMin = (float)(
        oneMinusBlend * (long double)alias->volumeMin +
        (long double)aliasBlend *
            (long double)secondaryAlias->volumeMin);
    const float volumeMax = (float)(
        oneMinusBlend * (long double)alias->volumeMax +
        (long double)aliasBlend *
            (long double)secondaryAlias->volumeMax);
    const float pitchMin = (float)(
        oneMinusBlend * (long double)alias->pitchMin +
        (long double)aliasBlend *
            (long double)secondaryAlias->pitchMin);
    const float pitchMax = (float)(
        oneMinusBlend * (long double)alias->pitchMax +
        (long double)aliasBlend *
            (long double)secondaryAlias->pitchMax);

    const long double volumeRandom =
        (long double)coduo_crt_rand() *
        (long double)MSS_RANDOM_UNIT;
    *outVolume = (float)(
        ((long double)volumeMin +
         volumeRandom *
             ((long double)volumeMax - (long double)volumeMin)) *
        (long double)MSS_ALIAS_VOLUME_SCALE);

    const long double pitchRandom =
        (long double)coduo_crt_rand() *
        (long double)MSS_RANDOM_UNIT;
    *outPitch = (float)(
        (long double)pitchMin +
        pitchRandom *
            ((long double)pitchMax - (long double)pitchMin));
}
    ...
    int32_t *outChannelIndex, int32_t timeShift)
{
    ...
    if (MSS_IsAliasChannel3D(alias->channel)) {
        const long double oneMinusBlend =
            (long double)1.0f - (long double)aliasBlend;
        const float maximumDistance = (float)(
            oneMinusBlend * (long double)alias->distanceMax +
            (long double)aliasBlend *
                (long double)secondaryAlias->distanceMax);
        if (VectorDistanceSquared(position, mss_listenerOrigin) >
            (long double)maximumDistance *
                (long double)maximumDistance) {
            return 0;
        }
    ...
    if (MSS_ContinueLoopingSound(
            alias, secondaryAlias, aliasBlend, pitchScale, effectId,
            position, outChannelIndex)) {
        return 0;
    }
    ...
    float volume;
    float pitch;
    MSS_ChoosePitchAndVolume(alias, secondaryAlias, aliasBlend,
                             &volume, &pitch);
    if (pitchScale != 0.0f)
        pitch = (float)((long double)pitch *
                        (long double)pitchScale);

    if (alias->type == SND_ALIAS_TYPE_LOADED) {
        return MSS_StartAliasSample(
            outChannelIndex, alias, secondaryAlias, aliasBlend, effectId,
            position, volume, pitch, timeShift);
    }
    if (alias->type == SND_ALIAS_TYPE_STREAMED) {
        return MSS_StartAliasStream(
            outChannelIndex, alias, secondaryAlias, aliasBlend, effectId,
            position, volume, pitch, timeShift, 0.0f);
    }
    return 0;
}
                           ...
                           const vec3_t position, int32_t timeShift)
{
    ...
    return MSS_PlaySoundAlias_Internal(
        alias, alias, 0.0f, 0.0f, effectId, position, NULL, timeShift);
}
                                     ...
                                     qboolean reportError)
{
    ...
    if (alias->soundFile != secondaryAlias->soundFile) {
        if (reportError) {
            Com_Error(
                ERR_DROP,
                "\x15" "tried to blend between sound aliases '%s' and '%s', "
    ...
    if (alias->loop != 0 &&
        (alias->volumeMin != alias->volumeMax ||
         secondaryAlias->volumeMin != secondaryAlias->volumeMax)) {
        if (reportError) {
            Com_Error(
                ERR_DROP,
                "\x15" "tried to blend between sound aliases '%s' and '%s', "
    ...
    int32_t effectId, const vec3_t position, int32_t timeShift)
{
    ...
    if (aliasBlend < 0.0f) {
        ...
        pitchScale = (float)(
            floor((double)absoluteBlend) *
            (double)MSS_ENCODED_PITCH_PERCENT_SCALE);
        aliasBlend = (float)(
            (double)absoluteBlend - floor((double)absoluteBlend));
    } else {
        pitchScale = 1.0f;
    }
...
int32_t MSS_PlayLocalSoundAlias(const char *name, sndAliasBank_t bank)
{
    ...
    snd_alias_t *const alias =
        Com_PickSoundAlias(name, bank, vec3_origin);
    if (alias == NULL)
        return 0;
                         ...
                         int32_t fadeTimeMsec)
{
    ...
    if (MSS_IsAliasChannel3D(alias->channel)) {
        Com_Error(
            ERR_DROP,
            "\x15" "alias %s sound %s played as an ambient / music track "
    ...
    const long double volumeRandom =
        (long double)coduo_crt_rand() *
        (long double)MSS_RANDOM_UNIT;
    const float volume = (float)(
        ((long double)alias->volumeMin +
         volumeRandom *
             ((long double)alias->volumeMax -
              (long double)alias->volumeMin)) *
        (long double)MSS_ALIAS_VOLUME_SCALE);
    const long double pitchRandom =
        (long double)coduo_crt_rand() *
        (long double)MSS_RANDOM_UNIT;
    const float pitch = (float)(
        (long double)alias->pitchMin +
        pitchRandom *
            ((long double)alias->pitchMax -
             (long double)alias->pitchMin));
    ...
    (void)MSS_StartAliasStreamOnChannel(
        alias, alias, 0.0f, MSS_EFFECT_ID_LIMIT, mss_listenerOrigin,
        volume, pitch, 0, 0.0f, channelIndex);

    mss_background_fade_t *const fade =
        &mss_backgroundFades[backgroundIndex];
    mss_channel_info_t *const channel = &mss_channelInfo[channelIndex];
    fade->targetVolume = channel->logicalVolume;
    if (fadeTimeMsec > 0) {
        fade->ratePerMsec = (float)(
            (long double)channel->logicalVolume /
            (long double)fadeTimeMsec);
...
void MSS_PlayMusicAlias(snd_alias_t *alias)
{
    if (mss_digitalDriver == NULL || alias == NULL)
        return;
    if (MSS_IsStreamChannelFree(
            MSS_STREAM_CHANNEL_FIRST + MSS_MUSIC_BACKGROUND_INDEX)) {
        MSS_StartBackground(
            MSS_MUSIC_BACKGROUND_INDEX, alias,
            MSS_BACKGROUND_FADE_IMMEDIATE_MSEC);
    }
}
...
void MSS_PlayAmbientAlias(snd_alias_t *alias, int32_t fadeTimeMsec)
{
    ...
    const int32_t channelIndex =
        MSS_STREAM_CHANNEL_FIRST + currentIndex;
    if (!MSS_IsStreamChannelFree(channelIndex)) {
        mss_channel_info_t *const channel =
            &mss_channelInfo[channelIndex];
        ...
        if (currentAlias->soundFile == alias->soundFile &&
            currentAlias->loop == alias->loop &&
            currentAlias->pitchMin == alias->pitchMin &&
            currentAlias->pitchMax == alias->pitchMax &&
            currentAlias->channel == alias->channel) {
            channel->alias = alias;
            ...
            const long double volumeRandom =
                (long double)coduo_crt_rand() *
                (long double)MSS_RANDOM_UNIT;
            const float targetVolume = (float)(
                ((long double)alias->volumeMin +
                 volumeRandom *
                     ((long double)alias->volumeMax -
                      (long double)alias->volumeMin)) *
                (long double)MSS_ALIAS_VOLUME_SCALE);
            mss_background_fade_t *const fade =
                &mss_backgroundFades[currentIndex];
            if (fadeTimeMsec != 0) {
                fade->ratePerMsec = (float)(
                    ((long double)targetVolume -
                     (long double)fade->targetVolume) /
                    (long double)fadeTimeMsec);
            } else {
                fade->ratePerMsec = 0.0f;
    ...
    mss_ambientBackgroundIndex =
        MSS_AMBIENT_BACKGROUND_FIRST_INDEX +
        MSS_AMBIENT_BACKGROUND_SECOND_INDEX - currentIndex;
                         ...
                         int32_t channelCount)
{
    ...
    if (raw->sample == NULL) {
        Com_Error(
            ERR_DROP,
            "\x15" "MILES 2D sound sample allocation failed on raw channel\n");
    }
    ...
    raw->sampleTimePerByteMsec =
        1000.0 / (double)(sampleRate * sampleWidthBytes * channelCount);
}
...
int32_t MSS_RawSamplesTime(void)
{
    ...
    return coduo_fp_to_i32_extended(
        ...
        (long double)samplePosition *
            (long double)raw->sampleTimePerByteMsec);
}
...
void MSS_UpdateRawSamples(void)
{
    ...
    raw->readSegmentIndex =
        (raw->readSegmentIndex + 1) % MSS_RAW_BUFFER_COUNT;
}
                    ...
                    const void *sampleData)
{
    ...
    int32_t bytesRemaining = (int32_t)(
        (uint32_t)sampleFrameCount * (uint32_t)sampleWidthBytes *
    ...
    while (bytesRemaining != 0) {
        ...
        Com_Memcpy(
            raw->ringBuffer +
                raw->writeSegmentIndex * raw->segmentSize +
                raw->writeSegmentOffset,
            source, (size_t)copyBytes);
        ...
        if (raw->writeSegmentOffset == raw->segmentSize) {
            ...
            raw->writeSegmentIndex =
                (raw->writeSegmentIndex + 1) % MSS_RAW_BUFFER_COUNT;
        }
    }
}
...
void MSS_FadeAllSounds(float targetVolume, int32_t durationMsec)
{
    ...
    mss_masterVolume.ratePerMsec =
        targetVolume - mss_masterVolume.current;
    if (durationMsec != 0) {
        mss_masterVolume.ratePerMsec = (float)(
            (long double)mss_masterVolume.ratePerMsec /
            (long double)durationMsec);
    ...
    int32_t durationMsec)
{
    for (int32_t channel = 0;
         channel < SND_ALIAS_CHANNEL_COUNT; ++channel) {
        mss_channel_volume_t *const volume =
            &mss_channelVolumes[channel];
        volume->target = targetVolumes[channel];
        volume->ratePerMsec = volume->target - volume->current;
        if (durationMsec != 0) {
            volume->ratePerMsec = (float)(
                (long double)volume->ratePerMsec /
                (long double)durationMsec);
        }
    }
}
...
void MSS_PauseSounds(void)
{
    ...
    for (int32_t channelIndex = first2DChannel;
         channelIndex < end2DChannel; ++channelIndex) {
        if (!MSS_Is2DChannelFree(channelIndex) &&
            mss_channelInfo[channelIndex].alias->channel !=
                SND_ALIAS_CHANNEL_MENU) {
    ...
    const int32_t endStreamChannel =
        firstStreamChannel + mss_streamChannelCount;
    for (int32_t channelIndex = firstStreamChannel;
         channelIndex < endStreamChannel; ++channelIndex) {
        if (!MSS_IsStreamChannelFree(channelIndex) &&
            mss_channelInfo[channelIndex].alias->channel !=
                SND_ALIAS_CHANNEL_MENU) {
...
void MSS_UnpauseSounds(void)
{
    ...
    const int32_t timeShift = (int32_t)(
        (uint32_t)mss_soundTime - (uint32_t)mss_pauseStartTime);
    ...
    for (int32_t channelIndex = first2DChannel;
         channelIndex < end2DChannel; ++channelIndex) {
        if (!MSS_Is2DChannelFree(channelIndex) &&
            mss_channelInfo[channelIndex].paused) {
                                    ...
                                    int32_t elapsedMsec)
{
    ...
    mss_channel_info_t *const channel =
        &mss_channelInfo[channelIndex];
    long double updatedVolume =
        (long double)elapsedMsec * fade->ratePerMsec +
        channel->logicalVolume;
...
{
    long double updated =
        (long double)elapsedMsec * volume->ratePerMsec + volume->current;
...
void MSS_UpdateMasterVolumes(int32_t elapsedMsec)
{
    for (int32_t channel = 0;
        ...
        float updated = (float)((long double)elapsedMsec * volume->ratePerMsec +
                                volume->current);
    ...
    if (mss_masterVolume.ratePerMsec == 0.0f) {
        ...
        float updated =
            (float)((long double)elapsedMsec * mss_masterVolume.ratePerMsec +
                    mss_masterVolume.current);
        ...
        if (mss_masterVolume.current == 0.0f &&
            mss_masterVolume.ratePerMsec == 0.0f) {
            MSS_StopSounds(MSS_STOP_ALL_SOUNDS);
        }
    }
...
qboolean MSS_AnyMasters(void)
{
    for (int32_t channelIndex = 0;
         channelIndex < mss_max3DChannels; ++channelIndex) {
        if (!MSS_Is3DChannelFree(channelIndex) &&
            mss_channelInfo[channelIndex].alias->isMaster)
            return qtrue;
    }
...
void MSS_Update3DChannel(int32_t channelIndex)
{
    ...
    MSS_GetCurrent3DPosition(channel->effectId, channel->effectOffset,
                             position);
    MSS_Set3DPosition(sample, position);

    const float minimumDistance = (float)(
        (long double)oneMinusBlend *
            (long double)alias->distanceMin +
        (long double)aliasBlend *
            (long double)secondaryAlias->distanceMin);
    const float maximumDistance = (float)(
        (long double)oneMinusBlend *
            (long double)alias->distanceMax +
        (long double)aliasBlend *
            (long double)secondaryAlias->distanceMax);
    vec3_t listenerDelta;
    for (int32_t component = 0; component < 3; ++component) {
    ...
    if (mss_anyMasters && alias->isSlave) {
        const float slaveVolume = (float)(
            (long double)oneMinusBlend *
                (long double)alias->slavePercentage +
            (long double)aliasBlend *
                (long double)secondaryAlias->slavePercentage);
    ...
    if (mss_anyMasters && alias->isSlave) {
        ...
        const float slaveVolume = (float)(
            ((long double)1.0f - (long double)aliasBlend) *
                (long double)alias->slavePercentage +
            (long double)aliasBlend *
                (long double)channel->secondaryAlias->slavePercentage);
                             ...
                             int32_t elapsedMsec)
{
    const int32_t streamIndex =
        channelIndex - MSS_STREAM_CHANNEL_FIRST;
    if (streamIndex < MSS_ALIAS_STREAM_SLOT_FIRST &&
        !MSS_UpdateBackgroundVolume(streamIndex, elapsedMsec)) {
        return;
    }
    ...
    if (streamChannel->is3D) {
        MSS_GetCurrent3DPosition(channel->effectId,
                                 channel->effectOffset,
                                 streamChannel->position);
        MSS_SpatializeStream(streamIndex, &volume, &pan);
    }
...
int32_t MSS_RoomTypeFromString(const char *roomType)
{
    if (roomType[0] >= '0' && roomType[0] <= '9') {
        ...
        for (int32_t roomTypeIndex = 0;
             roomTypeIndex < MSS_ROOM_TYPE_COUNT; ++roomTypeIndex) {
            if (coduo_crt_stricmp(
                    roomType, mss_roomTypeNames[roomTypeIndex]) == 0) {
                return roomTypeIndex;
            }
        }
    }
    ...
    Com_Printf(
        "roomtype must be an integer from 0 to %i, or one of the following strings:\n",
                               ...
                               int32_t fadeMsec)
{
    ...
    if (fadeMsec < 1)
        fadeMsec = 1;
    mss_reverbRate = (float)(
        ((long double)mss_reverbTarget -
         (long double)mss_reverbLevel) /
        (long double)fadeMsec);
}
...
void MSS_UpdateRoomEffects(int32_t elapsedMsec)
{
    ...
    mss_reverbLevel = (float)(
        (long double)elapsedMsec * (long double)mss_reverbRate +
        (long double)mss_reverbLevel);
    if ((!(mss_reverbRate < 0.0f) &&
...
void MSS_Update(void)
{
    ...
    if (com_statmon->integer != 0 &&
        ...
        StatMon_Warning(MSS_SOUND_CPU_WARNING_ENTRY,
                        MSS_SOUND_CPU_WARNING_DURATION_MSEC,
                        "gfx/2d/warning@soundcpu.jpg");
    }

    const uint32_t now = Sys_Milliseconds();
    const int32_t elapsedMsec =
        (int32_t)(now - (uint32_t)mss_soundTime);
    mss_soundTime = (int32_t)(
        (uint32_t)mss_soundTime + (uint32_t)elapsedMsec);
...
void MSS_StopSounds(uint32_t flags)
{
    ...
    const int32_t endStreamChannel =
        MSS_STREAM_CHANNEL_FIRST + mss_streamChannelCount;
    const int32_t musicChannel =
        MSS_STREAM_CHANNEL_FIRST + MSS_MUSIC_BACKGROUND_INDEX;
    const int32_t firstAmbientChannel =
        MSS_STREAM_CHANNEL_FIRST + MSS_AMBIENT_BACKGROUND_FIRST_INDEX;
    const int32_t secondAmbientChannel =
        MSS_STREAM_CHANNEL_FIRST + MSS_AMBIENT_BACKGROUND_SECOND_INDEX;
    for (int32_t channelIndex = MSS_STREAM_CHANNEL_FIRST;
         channelIndex < endStreamChannel; ++channelIndex) {
        if (MSS_IsStreamChannelFree(channelIndex))
            continue;
        if ((flags & MSS_STOP_PRESERVE_MUSIC) != 0 &&
            channelIndex == musicChannel) {
            continue;
        }
        if ((flags & MSS_STOP_PRESERVE_AMBIENT) != 0 &&
            (channelIndex == firstAmbientChannel ||
             channelIndex == secondAmbientChannel)) {
            continue;
        }
        MSS_StopStreamChannel(channelIndex);
    }
    ...
    if ((flags & MSS_STOP_PRESERVE_ROOM_EFFECTS) == 0)
        MSS_SetEnvironmentEffects("generic", MSS_DRY_REVERB_LEVEL,
                                  MSS_ENVIRONMENT_FADE_IMMEDIATE_MSEC);
}
...
{
    const mss_stream_channel_t *const stream =
        &mss_streamChannels[streamIndex];
    const mss_channel_info_t *const channel =
        &mss_channelInfo[MSS_STREAM_CHANNEL_FIRST + streamIndex];
    vec3_t direction;

    for (int32_t component = 0; component < 3; ++component) {
        direction[component] =
            stream->position[component] - mss_listenerOrigin[component];
    }
    const float distance = VectorNormalize(direction);
    const float rightProjection = (float)(
        (long double)mss_listenerAxis[1][2] * (long double)direction[2] +
        (long double)mss_listenerAxis[1][1] * (long double)direction[1] +
        (long double)mss_listenerAxis[1][0] * (long double)direction[0]);

    const long double oneMinusBlendWide =
        (long double)1.0f - (long double)channel->aliasBlend;
    const float oneMinusBlend = (float)oneMinusBlendWide;
    const float minimumDistance = (float)(
        oneMinusBlendWide * (long double)channel->alias->distanceMin +
        (long double)channel->aliasBlend *
            (long double)channel->secondaryAlias->distanceMin);
    const long double distancePastMinimum =
        (long double)distance - (long double)minimumDistance;
    ...
    if (distancePastMinimum <= (long double)0.0f) {
        ...
        const long double maximumDistance =
            (long double)oneMinusBlend *
                (long double)channel->alias->distanceMax +
            (long double)channel->aliasBlend *
                (long double)channel->secondaryAlias->distanceMax;
        const long double fraction =
            distancePastMinimum /
            (maximumDistance - (long double)minimumDistance);
    ...
    *pan = (float)(((long double)1.0f -
                    (long double)rightProjection) *
                   (long double)0.5f);
}
                        ...
                        int32_t durationMsec, int32_t timeShift)
{
    ...
    if (effectId >= 0 && effectId < MSS_EFFECT_ID_LIMIT &&
        MSS_IsAliasChannel3D(alias->channel)) {
        vec3_t effectOrigin;
        axis_t effectAxis;

        (void)VM_Call(coduo_cgameVm, CGVM_GET_EFFECT_ORIGIN_AXIS,
                      effectId, (intptr_t)effectOrigin,
                      (intptr_t)effectAxis, 0, 0, 0, 0, 0, 0, 0, 0, 0);
        const float deltaX = (float)(
            (long double)position[0] - (long double)effectOrigin[0]);
        const long double deltaY =
            (long double)position[1] - (long double)effectOrigin[1];
        const long double deltaZ =
            (long double)position[2] - (long double)effectOrigin[2];
        for (int32_t axis = 0; axis < 3; ++axis) {
            channel->effectOffset[axis] = (float)(
                (long double)effectAxis[axis][2] * deltaZ +
                (long double)effectAxis[axis][1] * deltaY +
                (long double)effectAxis[axis][0] *
                    (long double)deltaX);
        }
    } else {
    ...
    channel->aliasBlend = aliasBlend;
    channel->lastUpdateTime = mss_lastSoundTime;
    channel->endTime = (int32_t)(
        (uint32_t)mss_soundTime - (uint32_t)timeShift +
