...
_Static_assert(_Alignof(sfx_scheduled_effect_t) == 0x04,
               "i386 scheduled-effect alignment changed");
_Static_assert(offsetof(sfx_scheduled_effect_t, effectId) == 0x00,
               "i386 scheduled-effect id offset changed");
_Static_assert(sizeof(((sfx_scheduled_effect_t *)0)->effectId) == 0x04,
               "i386 scheduled-effect id extent changed");
_Static_assert(offsetof(sfx_scheduled_effect_t, primitiveIndex) == 0x04,
               "i386 scheduled-effect primitive-index offset changed");
_Static_assert(sizeof(((sfx_scheduled_effect_t *)0)->primitiveIndex) == 0x04,
               "i386 scheduled-effect primitive-index extent changed");
_Static_assert(offsetof(sfx_scheduled_effect_t, scheduledTime) == 0x08,
               "i386 scheduled-effect scheduled-time offset changed");
_Static_assert(sizeof(((sfx_scheduled_effect_t *)0)->scheduledTime) == 0x04,
               "i386 scheduled-effect scheduled-time extent changed");
_Static_assert(offsetof(sfx_scheduled_effect_t, boltInfo) == 0x0c,
               "i386 scheduled-effect bolt-info offset changed");
_Static_assert(sizeof(((sfx_scheduled_effect_t *)0)->boltInfo) == 0x08,
               "i386 scheduled-effect bolt-info extent changed");
_Static_assert(offsetof(sfx_scheduled_effect_t, origin) == 0x14,
               "i386 scheduled-effect origin offset changed");
_Static_assert(sizeof(((sfx_scheduled_effect_t *)0)->origin) == 0x0c,
               "i386 scheduled-effect origin extent changed");
_Static_assert(offsetof(sfx_scheduled_effect_t, axis) == 0x20,
               "i386 scheduled-effect axis offset changed");
_Static_assert(sizeof(((sfx_scheduled_effect_t *)0)->axis) == 0x24,
               "i386 scheduled-effect axis extent changed");
_Static_assert(sizeof(sfx_scheduled_effect_t) == 0x44,
               "i386 scheduled-effect size changed");
#endif
...
#if UINTPTR_MAX == UINT32_MAX
_Static_assert(_Alignof(fx_effect_slot_t) == 0x04,
               "i386 FX slot alignment changed");
_Static_assert(offsetof(fx_effect_slot_t, effect) == 0x00,
               "i386 FX slot effect offset changed");
_Static_assert(sizeof(((fx_effect_slot_t *)0)->effect) == 0x04,
               "i386 FX slot effect extent changed");
_Static_assert(offsetof(fx_effect_slot_t, expirationTime) == 0x04,
               "i386 FX slot expiration-time offset changed");
_Static_assert(sizeof(((fx_effect_slot_t *)0)->expirationTime) == 0x04,
               "i386 FX slot expiration-time extent changed");
_Static_assert(offsetof(fx_effect_slot_t, next) == 0x08,
               "i386 FX slot free-list link offset changed");
_Static_assert(sizeof(((fx_effect_slot_t *)0)->next) == 0x04,
               "i386 FX slot free-list link extent changed");
_Static_assert(sizeof(fx_effect_slot_t) == 0xc,
               "i386 FX slot size changed");
#endif
...
void CFxScheduler_PlaySimpleEffect(cfx_scheduler_t *scheduler,
                                   const char *name,
                                   const vec3_t origin);
void CFxScheduler_PlayEffect(cfx_scheduler_t *scheduler, const char *name,
                             const vec3_t origin,
...
void RE_AddRefEntityToScene(const refEntity_t *entity,
