...
#define QGL_GL_ENTRY(type_, name_) \
    extern type_ rendererGl##name_##Driver;
...
void RENDERER_GL_API_CALL GL_LogVertexAttrib1fARB(
    uint32_t index, float x);
void RENDERER_GL_API_CALL GL_LogVertexAttrib1dARB(
...
void RENDERER_GL_API_CALL GL_LogColor3f(
...
void RENDERER_GL_API_CALL GL_LogPixelTransferi(uint32_t parameter,
                                               int32_t value);
...
void RENDERER_GL_API_CALL GL_LogRasterPos4d(double x, double y,
                                            double z, double w);
void RENDERER_GL_API_CALL GL_LogRasterPos4dv(const double *values);
void RENDERER_GL_API_CALL GL_LogRasterPos4f(float x, float y,
                                            float z, float w);
void RENDERER_GL_API_CALL GL_LogRasterPos4fv(const float *values);
void RENDERER_GL_API_CALL GL_LogRasterPos4i(int32_t x, int32_t y,
                                            int32_t z, int32_t w);
void RENDERER_GL_API_CALL GL_LogRasterPos4iv(const int32_t *values);
void RENDERER_GL_API_CALL GL_LogRasterPos4s(int16_t x, int16_t y,
                                            int16_t z, int16_t w);
