...
_Static_assert(_Alignof(renderer_static_vertex_memory_base_t) == 0x4, "renderer_static_vertex_memory_base_t original alignment");
_Static_assert(offsetof(renderer_static_vertex_memory_base_t, address) == 0x0, "renderer_static_vertex_memory_base_t address offset");
_Static_assert(sizeof(((renderer_static_vertex_memory_base_t *)0)->address) == 0x4, "renderer_static_vertex_memory_base_t address extent");
_Static_assert(offsetof(renderer_static_vertex_memory_base_t, glBuffer) == 0x0, "renderer_static_vertex_memory_base_t glBuffer offset");
_Static_assert(sizeof(((renderer_static_vertex_memory_base_t *)0)->glBuffer) == 0x4,
               "renderer_static_vertex_memory_base_t glBuffer extent");
_Static_assert(offsetof(renderer_static_vertex_memory_base_t, atiObjectBuffer) == 0x0,
               "renderer_static_vertex_memory_base_t atiObjectBuffer offset");
_Static_assert(sizeof(((renderer_static_vertex_memory_base_t *)0)->atiObjectBuffer) == 0x4,
               "renderer_static_vertex_memory_base_t atiObjectBuffer extent");
_Static_assert(sizeof(renderer_static_vertex_memory_base_t) == 0x4, "renderer_static_vertex_memory_base_t original size");
#endif
