...
qboolean Sys_CheckProcessLock(void)
{
    ...
    if (lockFile != INVALID_HANDLE_VALUE) {
        ...
        /* NOT_FROM_ORIGINAL_SOURCE: a stale process marker does not imply
         * invalid settings. Only use a complete PID to prevent a second live
         * instance; otherwise rewrite the marker and load the config normally. */
