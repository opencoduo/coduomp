...
static inline void server_compat_game_debug_string(const intptr_t *arguments)
{
    ...
    CL_AddDebugString((const float *)arguments[1], (const float *)arguments[2], scale, (const char *)arguments[4], qtrue);
}
...
{
    CL_AddDebugLine((const float *)arguments[1], (const float *)arguments[2], (const float *)arguments[3], (qboolean)arguments[4],
                    (int32_t)arguments[5], qtrue);
}
