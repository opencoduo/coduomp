 ...
 */
CGAME_EXPORT intptr_t CGAME_ABI_CDECL vmMain(int32_t command, intptr_t arg0, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4,
                                             ...
                                             intptr_t arg11)
{
    ...
    case CGVM_INIT:
        CG_Init(coduo_int32_from_bits((uint32_t)arg0), coduo_int32_from_bits((uint32_t)arg1), coduo_int32_from_bits((uint32_t)arg2));
        break;
    ...
    case CGVM_DRAW_ACTIVE_FRAME:
        CG_DrawActiveFrame(coduo_int32_from_bits((uint32_t)arg0), coduo_int32_from_bits((uint32_t)arg1),
                           coduo_int32_from_bits((uint32_t)arg2), coduo_int32_from_bits((uint32_t)arg3),
                           coduo_int32_from_bits((uint32_t)arg4), coduo_int32_from_bits((uint32_t)arg5));
        break;
    ...
    case CGVM_KEY_EVENT:
        return (intptr_t)CG_KeyEvent(coduo_int32_from_bits((uint32_t)arg0), coduo_int32_from_bits((uint32_t)arg1));
    ...
    case CGVM_GET_MODEL_HANDLE: {
        int32_t modelIndex = coduo_int32_from_bits((uint32_t)arg0);
    ...
    case CGVM_DOBJ_CALC_POSE:
        CG_DObjCalcPose((centity_t *)(uintptr_t)arg0, (struct DObj_s *)(uintptr_t)arg1, (uint32_t *)(uintptr_t)arg2);
        break;

    case CGVM_DOBJ_CALC_BONE_GENERIC:
        CG_DObjCalcBoneGeneric(coduo_int32_from_bits((uint32_t)arg0), coduo_int32_from_bits((uint32_t)arg1));
        break;

    case CGVM_GET_ENTITY_ORIGIN_AXIS:
        CG_GetEntityOriginAxis(coduo_int32_from_bits((uint32_t)arg0), (float *)(uintptr_t)arg1, (float(*)[3])(uintptr_t)arg2);
        break;

    case CGVM_GET_EFFECT_ORIGIN_AXIS:
        CG_GetEffectOriginAxis(coduo_int32_from_bits((uint32_t)arg0), (float *)(uintptr_t)arg1, (float(*)[3])(uintptr_t)arg2);
        break;

    case CGVM_IMPACT_MARK:
        CG_ImpactMark(coduo_int32_from_bits((uint32_t)arg0), (const float *)(uintptr_t)arg1, (const float *)(uintptr_t)arg2,
                      CG_FloatFromBits((uint32_t)arg3), CG_FloatFromBits((uint32_t)arg4), CG_FloatFromBits((uint32_t)arg5),
                      CG_FloatFromBits((uint32_t)arg6), CG_FloatFromBits((uint32_t)arg7), coduo_int32_from_bits((uint32_t)arg8),
                      CG_FloatFromBits((uint32_t)arg9), coduo_int32_from_bits((uint32_t)arg10), /* temporary -> entry+0x28 */
    ...
    case CGVM_ADD_CAMERA_SHAKE: {
        ...
        long double radiusValue = (long double)coduo_int32_from_bits((uint32_t)arg3);
    ...
    case CGVM_DRAW_SCALED:
        ...
        CG_EmitTrap54DrawScaled(coduo_int32_from_bits((uint32_t)arg3), 1, NULL, (float)coduo_int32_from_bits((uint32_t)arg0),
                                (float)coduo_int32_from_bits((uint32_t)arg1), (void *)(uintptr_t)arg2,
                                (float)coduo_int32_from_bits((uint32_t)arg4), (float)coduo_int32_from_bits((uint32_t)arg5),
                                coduo_int32_from_bits((uint32_t)arg6));
        break;

    case CGVM_SCRIPT_FAR_HOOK:
        return (intptr_t)Scr_FarHook((const cg_scriptImportTable_t *)(uintptr_t)arg0);
