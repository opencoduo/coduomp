...
intptr_t CG_CreateMG42WeaponAnimTree(centity_t *slot)
{
    ...
    intptr_t treeHandle = cgame_syscall(CG_XANIM_CREATE_ANIMS, (intptr_t)bg_mg42WeaponName, 3);
    ...
    cgame_syscall(CG_XANIM_BLEND, treeHandle, 0, (intptr_t)bg_rootAnimationName, 1, 2, 0);
    ...
    cgame_syscall(CG_XANIM_CREATE, treeHandle, 1, (intptr_t)weaponInfo->idleAnim);
    ...
    cgame_syscall(CG_XANIM_CREATE, treeHandle, 2, (intptr_t)weaponInfo->fireAnim);
