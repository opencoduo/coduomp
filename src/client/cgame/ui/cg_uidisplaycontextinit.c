...
void CG_UIDisplayContextInit(void)
{
     ...
     * the display table exposes the same words as semantic floats. On i386,
     * both forms use identical stack dwords, so the casts preserve the
     * proved function-pointer values and call frames. Register-based 64-bit
     * ABIs require the adapters below. */
