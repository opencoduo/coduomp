...
float CG_DrawFPS(float y)
{
    ...
    x = (float)((long double)620.0f - (long double)visibleLength * (long double)16.0f); /* cellW 0x3007bf00 = 16.0 */
    ...
    x = (float)((long double)620.0f - (long double)cgame_compat_stats_visible_len(text) * (long double)8.0f);
