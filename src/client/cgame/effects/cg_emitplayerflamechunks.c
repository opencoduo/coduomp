                              ...
                              float spread, int32_t a3, int32_t a4)
{
    ...
    if (owner == cg_snap->ps.psClientNum &&
        cg_thirdPerson == 0) {
     ...
     * The recompute in the JNP-not-taken tail re-materialises the same deltaX. */
    {
        ...
        const long double divisor =
            (long double)clampedFrametime * (long double)0.001f; /* 0x3007bd94 = 0.001f */
        const float deltaY =
            fabsf(AngleNormalize180(viewAngles[1]
                  - info->prevDir[1] /* +0x08 */)) / divisor;
        const long double deltaX =
            (long double)fabsf(AngleNormalize180(viewAngles[0]
                  - info->prevDir[0] /* +0x04 */)) / divisor;
    ...
    emitOrigin[1] = (float)(
        ((long double)flashOrigin[1] + (long double)basisR[1] * 4.0f) +
        (long double)basisFullF[1] * 4.0f);
    emitOrigin[2] = (float)(
        ((long double)flashOrigin[2] + (long double)basisR[2] * 4.0f) +
        (long double)basisFullF[2] * 4.0f);
    ...
    long double vz = 0.0f;
    {
        ...
        const int32_t frameCutoff =
            coduo_int32_from_bits((uint32_t)cg_clientFrame - 1u);
        ...
        if (owner == clientNum) {
            ...
            const int32_t recentCutoff =
                coduo_int32_from_bits(cg_flameTime - 150u);
        ...
        if (owner == clientNum) {
            ...
            const long double speed = coduo_x87_sqrtl(
                ((long double)velX * velX + (long double)velY * velY) +
                (long double)velZ * velZ);
            if (speed > 1.0f) {
        ...
        if (!velPathTaken && spawnEnabled != 0) {
            ...
            const long double dz =
                (long double)emitOrigin[2] -
                (long double)info->prevEmitOrigin[2]; /* +0x18 */
            const int32_t dt = coduo_int32_from_bits(
                cg_flameTime - (uint32_t)info->lastEmitTime); /* +0x54 */
            /* denom = max((double)dt, 20.0) (0x3007c128 = 20.0). */
            const double denom = ((double)dt > 20.0) ? (double)dt : 20.0;
            const long double scale =
                (long double)1000.0f / (long double)denom; /* 1000.0f @0x3007be88 */
    ...
    {
        const long double alphaHalf =
            ((long double)alpha + (long double)1.0f) *
            (long double)0.5f;
    ...
    if (!(spawnEnabled != 0 && info->ownerChunk != NULL &&
     ...
     * no-op computed anyway. Preserved faithfully. (0x3002455b..0x300245bc) */
    {
        ...
        info->emitAccumTime = coduo_int32_from_bits(
            (uint32_t)info->emitAccumTime + (uint32_t)cg_frametime); /* +0x58 */
        if (reseedAlpha) {
            /* CG_FlameWaveNoise(t=cg_flameTime, b=0.334234f, a=0.197865f)
             * (pushes 0x3e4a9d34=a, 0x3eab20b8=b, t). */
            float n = Q_SwayRand(0.33423399925231934f,
                                 0.1978653073310852f,
                                 (float)coduo_int32_from_bits(cg_flameTime));
            ...
            alpha = (float)(powl(((long double)n + 1.0f) * 0.5f, 0.5L)
                            * 0.0f + 1.0f);
        }
    }
     ...
     * then scaled by a distance/spread factor. */
    {
        ...
        dblTemp68 = (double)(
            (long double)baseD * (long double)0.017777777777777778 *
            (long double)1000.0); /* @0x3007c108, @0x3007bd08 */
        if (isLocalFirstPerson == 0) {
            ...
            if (dist < 2048.0f) {                 /* 0x3007c100 = 2048.0f */
                ...
                const float clampedDist =
                    (dist > 6000.0f) ? 6000.0f : dist; /* @0x3007c0f8 */
                dblTemp68 = (double)(
                    (long double)clampedDist * (long double)0.00048828125f *
                    (long double)dblTemp68);
            }
        } else {
            ...
            long double factor =
                (long double)0.0025f * (long double)m; /* 0x3007bf54 = 0.0025f */
            if (!(factor >= 0.0f)) {
                factor = 0.0f;
        ...
        if (!(chunkEndTime <=
              (double)coduo_int32_from_bits(cg_flameTime))) {
    ...
    for (;;) {
        ...
        const float half = (float)(powl(
            (long double)coduo_crt_rand() *
                (long double)3.0517578125e-05f,
            1.0L) * (long double)0.5f); /* [0x60] temp (0x3007bce8) */
        /* CG_FlameWaveNoise stack args (top->): PUSH 0x409729fe = 4.723876f,
         * PUSH 0x40d0b7d4 = 6.52244f (6.522439f would be 2 ULP low at
         * 0x40d0b7d2), endTimeF. */
        const long double n1Raw =
            (long double)Q_SwayRand(
                4.723876f, 6.52244f, endTimeF) *
            (long double)0.5f;
        const float n1b = (float)(
            (n1Raw + (long double)1.0f) * (long double)0.25f +
            (long double)half); /* [0x14] (0x3007be58=0.25) */
        ...
        const long double n2 =
            ((long double)Q_SwayRand(
                 10.453760147094727f, 11.476519584655762f, endTimeF) +
             (long double)1.0f) *
            (long double)0.125f; /* 0x3007c0e8 */
        const long double density =
            (n2 + (long double)n1b) *
            ((long double)a075 + (long double)0.34999999f) *
            (long double)140.0f; /* 0x3007c0e4, 0x3007bec8 */
        ...
        chunk->startSpeedBits = (uint32_t)CG_FloatBits((float)(
            ((long double)a075 + (long double)0.25f) *
            ((long double)140.0f -
             (long double)chunk->smokeDensityRate)));
        ...
        if (isLocalFirstPerson != 0) {
            ...
            if (info->emitSeedGate > radiusSeed) {        /* +0x4c; 0x30024c2b JG */
                doBlock = 1;
            } else if (info->emitSeedGate >=
                       coduo_int32_from_bits((uint32_t)radiusSeed - 200u)) { /* 0x30024c35 JGE skip (0xc8=200) */
                doBlock = 0;
            } else {
                doBlock = 1;
            }
            if (doBlock) {
                ...
                const int32_t denom = coduo_int32_from_bits(
                    ((uint32_t)chunkCount - (uint32_t)quarter) -
                    (uint32_t)tenth);/* 0x30024c64/66 */
                const int32_t scatterRemainder = r % denom;
                chunk->emitScatterIndex = (uint32_t)coduo_int32_from_bits(
                    ((uint32_t)scatterRemainder + (uint32_t)radiusSeed) +
        ...
        chunk->sizeRate = (float)(
            (long double)alpha *
            (long double)CG_FloatFromBits(chunk->startSpeedBits) *
            (long double)0.0006002400768920779f);
        ...
        if (adsGate != 0) {
            ...
            chunk->driftSpeed = (float)(
                ((long double)alpha * (long double)0.89999998f +
                 (long double)0.10000000f) *
                (long double)900.0f);
        }
        ...
        chunk->driftDir[0] = nbFwd[0];   chunk->axisDir[0] = nbFwd[0];
        chunk->driftDir[1] = nbFwd[1];   chunk->axisDir[1] = nbFwd[1];
        chunk->driftDir[2] = nbFwd[2];   chunk->axisDir[2] = nbFwd[2];
        chunk->soundAmpRate = alpha;      /* [EDI+0xb8] = [0x174] */
        VectorNormalize(&chunk->driftDir[0]);                           /* 0x30024d13 */
        chunk->driftDir[0] = (float)(
            (long double)chunk->driftDir[0] * chunk->driftSpeed + accum1[0]); /* 0x30024d1a */
        chunk->driftDir[1] = (float)(
            (long double)chunk->driftSpeed * chunk->driftDir[1] + accum1[1]); /* 0x30024d2b */
        chunk->driftDir[2] = (float)(
            (long double)chunk->driftDir[2] * chunk->driftSpeed + accum1[2]); /* 0x30024d44 */
        ...
        chunk->localPos[0] = accum0[0];  chunk->posCopy[0] = accum0[0];
        chunk->localPos[1] = accum0[1];  chunk->posCopy[1] = accum0[1];
        chunk->driftStartTime = chunkEndTime;
        chunk->endTimeCopy = chunkEndTime;
        chunk->localPos[2] = accum0[2];  chunk->posCopy[2] = accum0[2];
        ...
        long double lifeStart = 0.0;
        {
            ...
            const long double rTerm =
                ((long double)1.0f -
                 (long double)clamped58 * (long double)0.001f) *
                    (long double)0.25f +
                (long double)0.75f;
            long double R;
            if (rTerm > (long double)scaleD * (long double)v) {
                ...
                if ((long double)scaleD * (long double)v2 >
                    (long double)20.0) {
                    R = 20.0;                          /* c128 */
                } else {
         ...
         * field_130. (0x30025082 CMP owner,0x40; JGE skips) */
        {
            ...
            if (owner2 < 64) {
                ...
                const long double len = coduo_x87_sqrtl(
                    ((long double)vDir[0] * vDir[0] +
                     (long double)vDir[1] * vDir[1]) +
                    (long double)vDir[2] * vDir[2]);
        ...
        info->lastFlameTime =
            (double)coduo_int32_from_bits(cg_flameTime);   /* +0xb0 */
         ...
         * field_a0=0. (0x3002512a..0x30025177) */
        {
            ...
            chunk->radiusBaseB = (float)(
                (long double)r9c *
                (long double)3.0517578125e-05f *
                (long double)360.0f);  /* 0x30025177 */
        }
        ...
        if (!((double)coduo_int32_from_bits(cg_flameTime) >=
              chunkEndTime)) { /* 0x300251eb FCOMP; TEST AH,1 */
...
region_c_terminalChunk:
    {
        ...
        info->emitCounter = coduo_int32_from_bits(
            (uint32_t)info->emitCounter + 1u); /* +0x90; 0x30025251 INC; store */
        ...
        term->endTime = (double)coduo_int32_from_bits(
            (uint32_t)flameTimeSigned + (uint32_t)chunkCount); /* 0x300252b4..0x300252c2 */
         ...
         * field_60:=0 first. */
        {
            ...
            float e = (float)(
                ((long double)oldf60 *
                     (long double)0.006428571417927742f +
                 (long double)0.89999998f) *
                (long double)16.0f);
            term->radius = e;
            term->startSpeed = e;
        }
        ...
        {
            const long double speedRaw =
                (long double)regionATemp10 * (long double)140.0f;
            term->startSpeedBits = (uint32_t)CG_FloatBits((float)speedRaw);
            term->sizeRate = (float)(speedRaw * alpha *
                                     0.0006002400768920779f);
        }
        ...
        if (adsGate != 0) {
            ...
            term->driftSpeed = (float)(
                ((long double)alpha * (long double)0.699999988f +
                 (long double)0.30000001f) *
                (long double)900.0f);
        }
        ...
        term->driftDir[0] = basisFullF[0];  term->axisDir[0] = basisFullF[0];
        term->driftDir[1] = basisFullF[1];  term->axisDir[1] = basisFullF[1];
        term->driftDir[2] = basisFullF[2];  term->axisDir[2] = basisFullF[2];
        term->soundAmpRate = alpha;
        VectorNormalize(&term->driftDir[0]);             /* 0x30025399 */
        term->driftDir[0] = (float)(
            (long double)term->driftDir[0] * term->driftSpeed + vDir[0]); /* 0x300253a0 (+[0x20]) */
        term->driftDir[1] = (float)(
            (long double)term->driftSpeed * term->driftDir[1] + vDir[1]); /* 0x300253ae (+[0x24]) */
        term->driftDir[2] = (float)(
            (long double)term->driftDir[2] * term->driftSpeed + vDir[2]); /* 0x300253c4 (+[0x28]) */
        ...
        /* Preserve this recovered boundary's validated input, state, and compatibility invariants. */
        {
            int32_t rr = coduo_fp_to_i32_extended(
                (long double)0.0 /
                (long double)timescale_vmCvar.value) % 360;
         ...
         * field_b8=alpha ; field_100/104/108 = dirCopy (0x30025440..0x30025498) */
        {
            ...
            term->radiusBaseB = (float)(
                (long double)r9 *
                (long double)3.0517578125e-05f *
                (long double)360.0f);  /* 0x30025492 */
        }
