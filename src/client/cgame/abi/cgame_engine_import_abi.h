...
typedef void(CGAME_ABI_CDECL *cgame_import_precache_anim_trees32_t)(cgame_abi_pointer32_t allocator_callback);
typedef cgame_abi_pointer32_t(CGAME_ABI_CDECL *cgame_import_find_anim_tree32_t)(cgame_abi_pointer32_t name);
typedef void(CGAME_ABI_CDECL *cgame_import_find_anim32_t)(cgame_abi_pointer32_t treeName, cgame_abi_pointer32_t animName,
                                                          cgame_abi_pointer32_t outAnim);
typedef uint32_t(CGAME_ABI_CDECL *cgame_import_get_anims_index32_t)(cgame_abi_pointer32_t anims);

_Static_assert(sizeof(cgame_engine_import_table32_t) == 408, "original direct-import table is 102 dwords");
